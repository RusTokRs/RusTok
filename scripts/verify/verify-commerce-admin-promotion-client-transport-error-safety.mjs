...
const paths = {
  ...
  facade: "crates/modules/rustok-commerce/admin/src/transport/promotion.rs",
  safety:
  ...
  evidence:
    "crates/modules/rustok-commerce/contracts/evidence/admin-promotion-client-transport-error-safety-source.json",
  review:
    "crates/modules/rustok-commerce/contracts/evidence/admin-promotion-client-transport-error-safety-source-review.json",
  doc: "crates/modules/rustok-commerce/docs/admin-promotion-client-transport-error-safety.md",
