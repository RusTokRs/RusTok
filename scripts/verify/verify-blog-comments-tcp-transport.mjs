...
const evidencePath = 'crates/modules/rustok-blog/contracts/evidence/blog-comments-tcp-transport.json';
...
const planPath = 'crates/modules/rustok-blog/docs/implementation-plan-slice-68.md';
