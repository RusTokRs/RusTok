...
const failures = [];
const paths = {
  contract: "crates/modules/rustok-forum/contracts/forum-search-owner-revision-checkpoint.json",
  note: "crates/modules/rustok-forum/docs/forum-23b2g2b2-search-owner-revision-checkpoint.md",
  ...
  hardeningContract: "crates/modules/rustok-forum/contracts/forum-search-owner-revision-counter-hardening.json",
  ingestContract: "crates/modules/rustok-forum/contracts/forum-search-durable-ingest-sequence.json",
  migration: "crates/modules/rustok-search/src/migrations/m20260731_000012_create_forum_owner_revision_checkpoints.rs",
  migrationRegistry: "crates/modules/rustok-search/src/migrations/mod.rs",
  predecessorMigration: "crates/modules/rustok-search/src/migrations/m20260731_000010_add_forum_projection_ingest_sequence.rs",
  lookupMigration: "crates/modules/rustok-search/src/migrations/m20260731_000011_add_forum_projection_ingest_sequence_lookup.rs",
  checkpointOwner: "crates/modules/rustok-search/src/forum_owner_checkpoint.rs",
  ...
  oldSweeperTest: "crates/modules/rustok-search/tests/forum_projection_sweeper_contract.rs",
  oldSweeperVerifier: "scripts/verify/verify-forum-search-inbox-sweeper.mjs",
  rootEvents: "crates/libs/rustok-events/src/types.rs",
  eventContracts: "crates/libs/rustok-events/src/contract.rs",
