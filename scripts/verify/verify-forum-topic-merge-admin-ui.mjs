...
const paths = {
  contract: "crates/modules/rustok-forum/contracts/forum-topic-merge-admin-ui.json",
  docs: "crates/modules/rustok-forum/docs/forum-21n-topic-merge-admin-ui.md",
  nativeContract:
    "crates/modules/rustok-forum/contracts/forum-topic-merge-native-admin.json",
  nativeDocs: "crates/modules/rustok-forum/docs/forum-21o-topic-merge-native-admin.md",
  plan: "crates/modules/rustok-forum/docs/implementation-plan.md",
  backend: "crates/modules/rustok-forum/src/graphql/topic_merge_mutation.rs",
  manifest: "crates/modules/rustok-forum/rustok-module.toml",
  leptosReadme: "crates/modules/rustok-forum/admin/README.md",
  leptosModel: "crates/modules/rustok-forum/admin/src/topic_merge_model.rs",
  leptosFacade: "crates/modules/rustok-forum/admin/src/transport.rs",
  leptosNative:
