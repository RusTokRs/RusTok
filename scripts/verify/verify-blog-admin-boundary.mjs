...
for (const marker of [
  ...
  "blog_post_admin_body_format_warning_view",
  "show_archive_action",
  "archive_label",
  "delete_label",
...
assertContains(ui, "core::blog_post_admin_body_format_warning_view", `${uiPath}: UI must use core-owned body-format warning view policy`);
