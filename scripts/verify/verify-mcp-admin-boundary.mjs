...
const leptosLibPath = "crates/modules/rustok-mcp/admin/src/lib.rs";
const leptosUiPath = "crates/modules/rustok-mcp/admin/src/ui/leptos.rs";
const transportModPath = "crates/modules/rustok-mcp/admin/src/transport/mod.rs";
const nativeAdapterPath = "crates/modules/rustok-mcp/admin/src/transport/native_server_adapter.rs";
const graphqlAdapterPath = "crates/modules/rustok-mcp/admin/src/transport/graphql_adapter.rs";
const mcpAdminCargoPath = "crates/modules/rustok-mcp/admin/Cargo.toml";
const managementContractPath = "crates/modules/rustok-mcp/src/management.rs";
const mcpAccessContractPath = "crates/modules/rustok-mcp/src/access.rs";
...
const aiLeptosUiPath = "crates/modules/rustok-ai/admin/src/ui/leptos.rs";
const mcpPlanPath = "crates/modules/rustok-mcp/docs/implementation-plan.md";
