...
for (const requiredPath of [files.contract, files.gate, files.runner.replace("scripts/evidence/admit-forum-page-builder-wave.mjs", "scripts/verify/verify-forum-page-builder-wave-admission.mjs")]) {
...
if (!(wave.verification?.no_compile_gates ?? []).includes("node scripts/verify/verify-forum-page-builder-wave-admission.mjs")) {
