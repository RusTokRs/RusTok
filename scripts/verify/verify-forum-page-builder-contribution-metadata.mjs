...
const widgetContract = read("crates/modules/rustok-forum/src/services/widget_contract.rs");
const widgetPreview = read("crates/modules/rustok-forum/src/services/widget_preview.rs");
const topicWidgetPreview = read("crates/modules/rustok-forum/src/services/topic_widget_preview.rs");
const widgetController = read("crates/modules/rustok-forum/src/controllers/widgets.rs");
const forumAdminCargo = read("crates/modules/rustok-forum/admin/Cargo.toml");
const forumAdminBuild = read("crates/modules/rustok-forum/admin/build.rs");
const forumAdminAdapter = read("crates/modules/rustok-forum/admin/src/page_builder.rs");
const forumAdminPreviewTransport = read("crates/modules/rustok-forum/admin/src/widget_preview_transport.rs");
const forumAdminPropertyTransport = read("crates/modules/rustok-forum/admin/src/widget_property_transport.rs");
const sharedTooling = read("crates/utils/rustok-build/src/module_manifest_contribution.rs");
const pageBuilderHost = read("crates/modules/rustok-page-builder/admin/src/contribution_host.rs");
const pageBuilderUi = read("crates/modules/rustok-page-builder/admin/src/ui/leptos.rs");
const pageBuilderPreviewPanel = read("crates/modules/rustok-page-builder/admin/src/editor/contribution_preview.rs");
const pageBuilderPropertiesPanel = read("crates/modules/rustok-page-builder/admin/src/editor/contribution_properties.rs");
