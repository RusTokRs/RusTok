...
for (const marker of [
  ...
  '"scripts/verify/verify-rbac-admin-tenant-scope.mjs"',
...
console.log(
  '[verify-tenant-hardening-workflow] read-only tenant/auth/RBAC admin/commerce/storefront, PostgreSQL and Redis evidence workflow is retained',
);
