...
requireAll('crates/modules/flex/src/entity_type.rs', [
  'pub const TAXONOMY_CATEGORY_ENTITY_TYPE: &str = "taxonomy.category";',
  "value.split('.').all(is_valid_field_key)",
]);

requireAll('crates/modules/flex/src/attached_definitions.rs', [
...
requireAll('crates/modules/flex/src/attached_storage.rs', [
...
requireAll('crates/modules/flex/src/migrations/m20260822_000001_create_generic_attached_donor_storage.rs', [
  'flex_attached_field_definitions',
  'flex_attached_values',
  'create_field_definition_cache_generation_trigger',
]);

requireAll('crates/modules/flex/src/graphql/runtime.rs', [
...
requireAll('crates/modules/flex/src/graphql/query.rs', [
...
requireAll('crates/modules/flex/src/graphql/mutation.rs', [
...
requireAll('crates/modules/rustok-taxonomy/src/owner_identity.rs', [
...
requireAll('crates/modules/flex/tests/generic_attached_definitions.rs', [
...
requireAll('crates/modules/flex/tests/generic_attached_storage.rs', [
  'generic_attached_values_split_shared_and_exact_locale_rows',
  'exact_locale_authoring_does_not_seed_from_read_fallback',
]);

requireAll('crates/modules/flex/tests/postgres_generic_attached_storage.rs', [
...
requireAll('crates/modules/rustok-taxonomy/tests/owner_identity.rs', [
...
requireAll('.github/workflows/taxonomy-category-flex-donor-contract.yml', [
  ...
  'crates/modules/flex/src/graphql/runtime.rs',
  'crates/modules/rustok-taxonomy/src/category_delete.rs',
...
for (const forbidden of [
  ...
  for (const file of rustFiles('crates/modules/rustok-taxonomy/src')) {
