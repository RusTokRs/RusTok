...
const files = {
  aiCargo: "crates/modules/rustok-ai/Cargo.toml",
  aiPort: "crates/modules/rustok-ai/src/ports.rs",
  aiLedger: "crates/modules/rustok-ai/src/structured.rs",
  aiAccounting: "crates/modules/rustok-ai/src/accounting.rs",
  aiRouter: "crates/modules/rustok-ai/src/router.rs",
  aiStructuredRuntime: "crates/modules/rustok-ai/src/structured_runtime.rs",
  aiStructuredLive: "crates/modules/rustok-ai/src/structured_live_tests.rs",
  aiStructuredResult: "crates/modules/rustok-ai/src/structured_result.rs",
  aiService: "crates/modules/rustok-ai/src/service.rs",
  aiScheduler: "crates/modules/rustok-ai/src/scheduler.rs",
  aiEntities: "crates/modules/rustok-ai/src/entities.rs",
  aiGraphqlQuery: "crates/modules/rustok-ai/src/graphql/query.rs",
  aiGraphqlMutation: "crates/modules/rustok-ai/src/graphql/mutation.rs",
  aiGraphqlTypes: "crates/modules/rustok-ai/src/graphql/types.rs",
  aiNativeAdmin:
    "crates/modules/rustok-ai/admin/src/transport/native_server_adapter.rs",
  aiGraphqlAdmin: "crates/modules/rustok-ai/admin/src/transport/graphql_adapter.rs",
  aiMigration:
    "crates/modules/rustok-ai/src/migrations/m20260729_000001_structured_execution.rs",
  ...
  translationMachineEntity:
    "crates/modules/rustok-translation/src/entities/machine_operation.rs",
  translationMemoryBindingEntity:
    "crates/modules/rustok-translation/src/entities/machine_memory_binding.rs",
  translationCancellationEntity:
    "crates/modules/rustok-translation/src/entities/machine_cancellation.rs",
  translationRecoveryEntity:
    "crates/modules/rustok-translation/src/entities/machine_recovery.rs",
  translationMachineMigration:
    "crates/modules/rustok-translation/src/migrations/m20260729_000009_create_translation_machine_operations.rs",
  ...
  distributionCargo: "crates/modules/rustok-distribution/Cargo.toml",
  distributionSource: "crates/modules/rustok-distribution/src/lib.rs",
  serverCargo: "apps/server/Cargo.toml",
  serverComposition: "apps/server/src/services/module_event_dispatcher.rs",
  adapterCargo: "crates/modules/rustok-ai-translation/Cargo.toml",
  adapterSource: "crates/modules/rustok-ai-translation/src/lib.rs",
  adapterReadme: "crates/modules/rustok-ai-translation/README.md",
  adapterPlan: "crates/modules/rustok-ai-translation/docs/implementation-plan.md",
};
