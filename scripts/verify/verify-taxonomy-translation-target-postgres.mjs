...
const failures = [];
const files = {
  test: 'crates/modules/rustok-taxonomy/tests/translation_target_postgres.rs',
  evidence:
    'crates/modules/rustok-taxonomy/contracts/evidence/taxonomy-translation-target-postgres.json',
  workflow: '.github/workflows/taxonomy-postgres-evidence.yml',
  serverMigrator: 'crates/utils/rustok-migrations/src/lib.rs',
  provider: 'crates/modules/rustok-taxonomy/src/translation_target.rs',
  owner: 'crates/modules/rustok-taxonomy/src/services.rs',
  changeWriter: 'crates/modules/rustok-taxonomy/src/translation_evidence.rs',
  plan: 'crates/modules/rustok-taxonomy/docs/implementation-plan.md',
};
const runtimeInputPaths = [
  'Cargo.toml',
  'Cargo.lock',
  'crates/libs/rustok-core/Cargo.toml',
  'crates/libs/rustok-core/src',
  'crates/utils/rustok-migrations/Cargo.toml',
  'crates/utils/rustok-migrations/src',
  'crates/modules/rustok-outbox/Cargo.toml',
  'crates/modules/rustok-outbox/src',
  'crates/modules/rustok-taxonomy/Cargo.toml',
  'crates/modules/rustok-taxonomy/src',
  'crates/modules/rustok-taxonomy/tests/route_registry_contention_postgres.rs',
  'crates/modules/rustok-taxonomy/tests/translation_target_postgres.rs',
  'crates/modules/rustok-translation-targets/Cargo.toml',
  'crates/modules/rustok-translation-targets/src',
