...
console.log(
  '[verify-taxonomy-translation-target-postgres] PASS source=canonical-migrator+harness+owner+provider+workflow runtime=exact-head-recorded+post-merge-pending+fingerprinted',
);
