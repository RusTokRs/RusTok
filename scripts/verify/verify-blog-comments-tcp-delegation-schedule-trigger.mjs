...
const planPath = 'crates/modules/rustok-blog/docs/implementation-plan-slice-80.md';
const evidencePath =
  'crates/modules/rustok-blog/contracts/evidence/blog-comments-tcp-delegation-schedule-trigger.json';
