...
const requestsPath = "crates/modules/rustok-commerce/storefront/src/core/requests.rs";
const presentationPath = "crates/modules/rustok-commerce/storefront/src/core/presentation.rs";
const modelPath = "crates/modules/rustok-commerce/storefront/src/model.rs";
const libPath = "crates/modules/rustok-commerce/storefront/src/lib.rs";
const uiPath = "crates/modules/rustok-commerce/storefront/src/ui/leptos/mod.rs";
...
const paymentTransportPath = "crates/modules/rustok-payment/storefront/src/transport.rs";
const paymentGraphqlPath = "crates/modules/rustok-payment/storefront/src/transport/graphql_adapter.rs";
const paymentNativeServerFunctionsPath = "crates/modules/rustok-payment/storefront/src/transport/native_server_adapter/server_functions.rs";
const orderTransportPath = "crates/modules/rustok-order/storefront/src/transport.rs";
const orderGraphqlPath = "crates/modules/rustok-order/storefront/src/transport/graphql_adapter.rs";
const orderNativeServerFunctionsPath = "crates/modules/rustok-order/storefront/src/transport/native_server_adapter/server_functions.rs";
const fulfillmentTransportPath = "crates/modules/rustok-fulfillment/storefront/src/transport.rs";
const fulfillmentGraphqlPath = "crates/modules/rustok-fulfillment/storefront/src/transport/graphql_adapter.rs";
const fulfillmentNativeServerFunctionsPath = "crates/modules/rustok-fulfillment/storefront/src/transport/native_server_adapter/server_functions.rs";
const commercePlanPath = "crates/modules/rustok-commerce/docs/implementation-plan.md";
const paymentPlanPath = "crates/modules/rustok-payment/docs/implementation-plan.md";
const orderPlanPath = "crates/modules/rustok-order/docs/implementation-plan.md";
const fulfillmentPlanPath = "crates/modules/rustok-fulfillment/docs/implementation-plan.md";
