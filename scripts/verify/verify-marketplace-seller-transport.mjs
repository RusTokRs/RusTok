...
const files = {
  manifest: "crates/modules/rustok-marketplace-seller/rustok-module.toml",
  ...
  graphql: "crates/modules/rustok-marketplace-seller/src/graphql.rs",
  adminModel: "crates/modules/rustok-marketplace-seller/admin/src/model.rs",
  nativeAdapter: "crates/modules/rustok-marketplace-seller/admin/src/transport/native_server_adapter.rs",
  graphqlAdapter: "crates/modules/rustok-marketplace-seller/admin/src/transport/graphql_adapter.rs",
  transport: "crates/modules/rustok-marketplace-seller/admin/src/transport.rs",
  ui: "crates/modules/rustok-marketplace-seller/admin/src/ui/leptos.rs",
