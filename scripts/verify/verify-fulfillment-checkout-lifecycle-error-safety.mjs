...
const source = read('crates/modules/rustok-fulfillment/src/checkout_execution_typed.rs');
const statusContract = read('crates/modules/rustok-fulfillment/src/status.rs');
