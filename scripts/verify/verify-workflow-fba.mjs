...
const registryPath = 'crates/modules/rustok-workflow/contracts/workflow-fba-registry.json';
const evidencePath = 'crates/modules/rustok-workflow/contracts/evidence/workflow-contract-test-static-matrix.json';
const runtimeSmokePath = 'crates/modules/rustok-workflow/contracts/evidence/workflow-read-projection-runtime-smoke.json';
const registry = json(registryPath);
const evidence = json(evidencePath);
const runtimeSmoke = json(runtimeSmokePath);
const runtimeOrderSmoke = json(registry.evidence.runtime_order_smoke);
const manifest = read('crates/modules/rustok-workflow/rustok-module.toml');
const plan = read('crates/modules/rustok-workflow/docs/implementation-plan.md');
const central = read('docs/modules/registry.md');
const lib = read('crates/modules/rustok-workflow/src/lib.rs');
const ports = read('crates/modules/rustok-workflow/src/ports.rs');
const dto = read('crates/modules/rustok-workflow/src/dto/mod.rs');
const nativeAdapter = read('crates/modules/rustok-workflow/admin/src/transport/native_server_adapter.rs');
const graphqlAdapter = read('crates/modules/rustok-workflow/admin/src/transport/graphql_adapter.rs');
