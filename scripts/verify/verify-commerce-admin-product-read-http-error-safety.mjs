...
const products = read('crates/modules/rustok-commerce/src/controllers/products.rs');
...
const catalogService = read('crates/modules/rustok-product/src/services/catalog.rs');
const failures = [];
