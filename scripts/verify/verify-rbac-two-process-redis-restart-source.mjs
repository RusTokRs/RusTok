...
console.log(
  "✔ source-ready RBAC two-process Redis harness proves the fast path without a watchdog and durable resubscribe recovery after a real Redis restart while retaining all runtime gates",
);
