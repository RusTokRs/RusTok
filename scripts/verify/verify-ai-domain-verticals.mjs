...
const files = {
  product: 'crates/modules/rustok-ai-product/src/lib.rs',
  content: 'crates/modules/rustok-ai-content/src/lib.rs',
  order: 'crates/modules/rustok-ai-order/src/lib.rs',
  media: 'crates/modules/rustok-ai-media/src/lib.rs',
  alloy: 'crates/modules/rustok-ai-alloy/src/lib.rs',
  commerceBinding: 'crates/modules/rustok-ai/src/direct_domain_commerce.rs',
  contentBinding: 'crates/modules/rustok-ai/src/direct_domain_content.rs',
  serviceHelpers: 'crates/modules/rustok-ai/src/service/helpers.rs',
  orderBinding: 'crates/modules/rustok-ai/src/direct_domain_orders.rs',
  mediaBinding: 'crates/modules/rustok-ai/src/direct_domain_media.rs',
  alloyBinding: 'crates/modules/rustok-ai/src/direct_domain_alloy.rs',
  productPlan: 'crates/modules/rustok-ai-product/docs/implementation-plan.md',
  contentPlan: 'crates/modules/rustok-ai-content/docs/implementation-plan.md',
  orderPlan: 'crates/modules/rustok-ai-order/docs/implementation-plan.md',
  mediaPlan: 'crates/modules/rustok-ai-media/docs/implementation-plan.md',
  alloyPlan: 'crates/modules/rustok-ai-alloy/docs/implementation-plan.md',
  aiPlan: 'crates/modules/rustok-ai/docs/implementation-plan.md',
};
