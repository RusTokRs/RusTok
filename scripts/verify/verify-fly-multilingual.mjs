...
const paths = {
  runtimeLocale: 'crates/ui/fly/src/runtime_locale.rs',
  localePolicy: 'crates/ui/fly/src/locale_policy.rs',
  localeCoverage: 'crates/ui/fly/src/locale_coverage.rs',
  localizedRoute: 'crates/ui/fly/src/localized_route.rs',
  translations: 'crates/ui/fly/src/translation.rs',
  ...
  ssrForms: 'crates/modules/rustok-page-builder/admin/src/editor/ssr_forms.rs',
  ssrLocale: 'crates/modules/rustok-page-builder/admin/src/editor/ssr_locale.rs',
  ssrLocalePolicy: 'crates/modules/rustok-page-builder/admin/src/editor/ssr_locale_policy.rs',
  ssrLocaleCoverage: 'crates/modules/rustok-page-builder/admin/src/editor/ssr_locale_coverage.rs',
