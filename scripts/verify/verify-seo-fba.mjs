...
hasAll(plan, ['- FBA status: `in_progress`', 'seo-fba-registry.json', 'MediaAssetReadPort', 'seo-media-consumer-static-matrix.json'], 'local plan');
...
hasAll(unified, ['`seo`', 'MediaAssetReadPort', 'seo-fba-registry.json'], 'unified plan');
