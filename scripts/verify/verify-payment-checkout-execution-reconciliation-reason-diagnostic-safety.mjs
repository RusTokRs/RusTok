...
const paths = {
  ...
  authorize: "crates/modules/rustok-payment/src/checkout_execution/prepare_authorize.rs",
  ...
  doc:
    "crates/modules/rustok-payment/docs/checkout-execution-reconciliation-reason-diagnostic-safety.md",
