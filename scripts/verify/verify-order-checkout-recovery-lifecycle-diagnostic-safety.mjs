...
const paths = {
  ...
  evidence:
    'crates/modules/rustok-order/contracts/evidence/checkout-order-recovery-lifecycle-diagnostic-safety-source-review.json',
  doc: 'crates/modules/rustok-order/docs/checkout-order-recovery-lifecycle-diagnostic-safety.md',
