...
export const BLOG_FBA_SOURCE_GATES = {
  admin_boundary: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-admin-richtext-boundary.json',
  },
  storefront_boundary: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-storefront-richtext-view.json',
  },
  comments_port_boundary: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-comments-consumer-static-matrix.json',
  },
  comments_event_projection: {
    ...
    unit_test: 'crates/modules/rustok-blog/src/services/comment_projection.rs',
    postgres_test: 'crates/modules/rustok-blog/tests/comment_projection_postgres_test.rs',
    restart_test: 'crates/modules/rustok-blog/tests/comment_projection_restart_postgres_test.rs',
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-comments-event-projection.json',
  },
  comments_duplicate_delivery_race: {
    ...
    postgres_test: 'crates/modules/rustok-blog/tests/comment_projection_duplicate_race_postgres_test.rs',
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-comments-duplicate-delivery-race.json',
  },
  comments_dispatcher_duplicate_delivery: {
    ...
    postgres_test: 'crates/modules/rustok-blog/tests/comment_projection_dispatcher_duplicate_postgres_test.rs',
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-comments-dispatcher-duplicate-delivery.json',
  },
  category_search_reindex: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-category-search-reindex-contract.json',
  },
  graphql_rate_limit: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-graphql-rate-limit-runtime-harness.json',
  },
  graphql_richtext_boundary: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-graphql-richtext-boundary.json',
  },
  ...
  forum_ui_ownership: {
    ...
    evidence: 'crates/modules/rustok-blog/contracts/evidence/blog-forum-ui-ownership.json',
  },
};
