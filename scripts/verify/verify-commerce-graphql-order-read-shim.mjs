...
const source = read('crates/modules/rustok-commerce/src/graphql/safe_query/source.rs');
const shim = read(
...
const note = read('crates/modules/rustok-commerce/docs/graphql-order-read-shim.md');
const failures = [];
