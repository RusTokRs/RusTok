...
const payments = read('crates/modules/rustok-commerce/src/controllers/admin/payments.rs');
...
const paymentService = read('crates/modules/rustok-payment/src/services/payment.rs');
const failures = [];
