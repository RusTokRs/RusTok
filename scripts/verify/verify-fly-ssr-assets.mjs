...
requireMarkers('assets', [
  ...
  'normalize_asset_source_attribute(&request.source_attribute)',
  'visit_project_components(&controller.editor().document().project',
  'asset_reference_component_ids(self, asset_id)',
  'is still referenced by component(s)',
  'providerFuture',
  ...
  'asset_apply_rejects_arbitrary_attribute_names',
  'referenced_asset_cannot_be_removed',
...
requireMarkers('browserTests', [
  ...
  'browser_dispatches_asset_upsert_apply_and_safe_remove_contracts',
  'referenced asset removal must fail',
  'undo asset assignment',
