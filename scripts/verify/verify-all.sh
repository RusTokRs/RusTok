...
usage() {
    ...
    echo "  csp-inline-style-exceptions  Verify every Rust-hosted inline style attribute is registered and bounded"
...
SCRIPTS=(
    ...
    "verify-csp-inline-style-exceptions.mjs:CSP Inline Style Exceptions"
