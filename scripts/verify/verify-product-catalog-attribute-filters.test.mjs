...
function fixture(options = {}) {
  ...
  write(root, "crates/modules/rustok-product/storefront/src/catalog_controls.rs", `pub attribute_filters: Vec<String> serialize_attribute_filters`);
  write(root, "crates/modules/rustok-product/storefront/src/ui/leptos.rs", options.omitStorefrontUi ? `` : `read_route_query_value(&route_context, "attribute_filters") name="attribute_filters"`);
  ...
  write(root, "crates/modules/rustok-product/storefront/src/transport/graphql_adapter.rs", `attributeFilters attribute_filters: controls.attribute_filters`);
  ...
  write(root, "crates/modules/rustok-commerce/src/graphql/product_catalog.rs", `pub attribute_filters: Vec<String> try_new_with_attribute_filters try_from_transport_with_attribute_filters`);
  write(root, "crates/modules/rustok-product/docs/implementation-plan.md", `- [x] Connect storefront/admin UI controls to optional catalog filters/sorts.\nConnect typed attribute_filters through storefront/admin UI state\nverify-product-catalog-attribute-filters.mjs`);
  return root;
}
