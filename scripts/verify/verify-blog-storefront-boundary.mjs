...
const files = {
  storefrontSrc: "crates/modules/rustok-blog/storefront/src",
  lib: "crates/modules/rustok-blog/storefront/src/lib.rs",
  core: "crates/modules/rustok-blog/storefront/src/core.rs",
  pagination: "crates/modules/rustok-blog/storefront/src/comments_pagination.rs",
  model: "crates/modules/rustok-blog/storefront/src/model.rs",
  ui: "crates/modules/rustok-blog/storefront/src/ui/leptos.rs",
  transport: "crates/modules/rustok-blog/storefront/src/transport/mod.rs",
  ...
  cargo: "crates/modules/rustok-blog/storefront/Cargo.toml",
  legacyApi: "crates/modules/rustok-blog/storefront/src/api.rs",
...
assertContains(transport, "fn configured_fallback_tenant_slug(requested: Option<&str>)", `${files.transport}: public/native tenant fallback must be constrained by the configured host tenant`);
...
for (const marker of [
  ...
  "runtime.comment_service(db.clone())",
  "list_public_comments_with_snapshot(",
