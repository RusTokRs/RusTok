...
const paths = {
  ...
  flyBrowserCargo: 'crates/ui/fly-browser/Cargo.toml',
  flyBrowserLib: 'crates/ui/fly-browser/src/lib.rs',
  flyBrowserJs: 'crates/ui/fly-browser/assets/fly-browser.js',
  flyLeptosCargo: 'crates/ui/fly-leptos/Cargo.toml',
  flyLeptosRoot: 'crates/ui/fly-leptos/src/root.rs',
  runtimePipeline: 'crates/ui/fly/src/runtime_pipeline.rs',
  pageBuilderLib: 'crates/modules/rustok-page-builder/src/lib.rs',
  pageBuilderBrowserHost: 'crates/modules/rustok-page-builder/src/browser_host.rs',
  adminCargo: 'crates/modules/rustok-page-builder/admin/Cargo.toml',
  adminAdapter: 'crates/modules/rustok-page-builder/admin/src/ui/browser_adapter.rs',
  adminCanvas: 'crates/modules/rustok-page-builder/admin/src/editor/modular_canvas.rs',
  adminEditorMod: 'crates/modules/rustok-page-builder/admin/src/editor/mod.rs',
  browserIntent: 'crates/modules/rustok-page-builder/admin/src/browser_intent.rs',
  capabilityAccess: 'crates/modules/rustok-page-builder/admin/src/capability_access.rs',
  draftSession: 'crates/modules/rustok-page-builder/admin/src/draft_session.rs',
  ssrAssets: 'crates/modules/rustok-page-builder/admin/src/editor/ssr_assets.rs',
  ...
  pagesProblem: 'crates/modules/rustok-pages/admin/src/browser_problem.rs',
