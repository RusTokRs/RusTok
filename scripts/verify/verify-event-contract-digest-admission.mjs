...
for (const forbidden of [
  ...
  if (workflow.includes(forbidden)) {
    fail(
      `${workflowPath} contains forbidden automatic mutation or trigger: ${forbidden}`,
    );
  }
}
...
const generatorPath =
  "crates/libs/rustok-events/examples/event_contract_digests.rs";
...
const canonicalTestPath =
  "crates/libs/rustok-events/tests/canonical_contracts.rs";
...
console.log(
  "[verify-event-contract-digest-admission] canonical digest admission workflow contract verified",
);
