...
requireText("crates/ui/fly/src/lib.rs", "mod landing_readiness;");
requireText("crates/ui/fly/src/lib.rs", "pub use landing_readiness::*;");
requireText("crates/ui/fly/src/lib.rs", "mod action;");
requireText("crates/ui/fly/src/lib.rs", "mod audit;");
requireText(
  "crates/ui/fly/src/runtime_validation.rs",
  "validate_component_actions(document)",
);
requireText(
  "crates/ui/fly/src/runtime_pipeline.rs",
  "pub materialized_forms: usize",
);
requireOrder("crates/ui/fly/src/runtime_pipeline.rs", [
...
requireText(
  "crates/ui/fly/src/runtime_render.rs",
  "pub native_actions: usize",
);
requireText(
  "crates/ui/fly/src/runtime_scenario_render.rs",
  "pub materialized_forms: usize",
);
requireText(
  "crates/ui/fly/src/runtime_scenario_render.rs",
...
requireOrder("crates/ui/fly/src/landing_readiness/evaluate.rs", [
...
requireText(
  "crates/ui/fly/src/landing_readiness/tests.rs",
  "structural_readiness_applies_schema_defaults_before_audit",
);
requireText(
  "crates/ui/fly/src/runtime_gate.rs",
...
requireText(
  "crates/ui/fly/src/page_metadata.rs",
  "localized_metadata_exposes_preview_and_round_trips_losslessly",
);
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/runtime.rs",
...
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/dynamic_runtime.rs",
...
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/runtime_publish_gate.rs",
  "page_builder.runtimePublishGate.readiness",
);
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/audit_panel.rs",
  "page_builder.audit.errors",
);
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/mod.rs",
  "mod audit_panel;",
);
requireText(
  "crates/modules/rustok-page-builder/admin/src/editor/mod.rs",
...
requireText(
  "crates/modules/rustok-page-builder/admin/src/browser_intent.rs",
