...
hasAll(aiAdminGraphql, ['aiAgentModelAssignments {', 'agentPrincipalId providerProfileId modelOverride executionMode isActive'], 'ai GraphQL assignment bootstrap');
...
hasAll(aiRuntimeFactory, ['pub fn ai_host_runtime_from_context(', 'AiHostRuntime::new('], 'ai runtime factory');
...
hasNone(aiGraphqlRuntime, ['AiHostRuntime::new('], 'ai GraphQL duplicate runtime construction');
hasNone(aiProviderNative, ['AiHostRuntime::new('], 'ai native duplicate runtime construction');
