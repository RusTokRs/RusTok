...
const registryPath = 'crates/modules/rustok-email/contracts/email-fba-registry.json';
const evidencePath = 'crates/modules/rustok-email/contracts/evidence/email-contract-test-static-matrix.json';
const registry = json(registryPath);
const evidence = json(evidencePath);
const manifest = read('crates/modules/rustok-email/rustok-module.toml');
const plan = read('crates/modules/rustok-email/docs/implementation-plan.md');
const central = read('docs/modules/registry.md');
const pkg = json('package.json');
const lib = read('crates/modules/rustok-email/src/lib.rs');
const cargo = read('crates/modules/rustok-email/Cargo.toml');
const ports = read('crates/modules/rustok-email/src/ports.rs');
