...
requireContains('apps/server/src/installer_execution.rs', 'execute_install_apply(&ports', 'server installer delegates apply sequencing to the installer foundation');
...
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'pub struct SeaOrmInstallerBootstrapPorts', 'SeaORM installer adapter owns reusable bootstrap composition');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'execute_seed_profile(', 'SeaORM installer adapter executes the canonical seed workflow');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'impl SeedTenantPort for SeaOrmInstallerBootstrapPorts', 'SeaORM installer adapter composes the tenant seed port');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'impl SeedIdentityPort for SeaOrmInstallerBootstrapPorts', 'SeaORM installer adapter composes the identity seed port');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'impl SeedRolePort for SeaOrmInstallerBootstrapPorts', 'SeaORM installer adapter composes the role seed port');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'impl SeedModulePort for SeaOrmInstallerBootstrapPorts', 'SeaORM installer adapter composes the module seed port');
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'ModuleLifecycleDbWriter::new', 'SeaORM installer adapter uses the module-owned lifecycle writer');
requireContains('apps/server/src/installer_execution.rs', 'SeaOrmInstallerBootstrapPorts::new', 'server composes reusable installer bootstrap ports');
requireNotContains('apps/server/src/installer_execution.rs', 'execute_seed_profile(', 'server does not duplicate canonical seed workflow composition');
...
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', '.ensure_tenant(', 'SeaORM installer adapter uses the tenant-owned provisioning API');
...
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'AuthUserBootstrapDbWriter::new', 'SeaORM installer adapter uses the auth-owned bootstrap writer');
...
requireContains('crates/rustok-installer-persistence/src/seaorm_ports.rs', 'RbacRoleAssignmentDbWriter::new', 'SeaORM installer adapter uses the RBAC-owned assignment writer');
requireNotContains('apps/server/src/installer_execution.rs', 'RbacService::', 'server installer does not retain a host-specific RBAC persistence path');
...
requireContains('crates/rustok-installer-cli/src/lib.rs', '"install",\n                "apply"', 'installer CLI adapter exposes typed apply');
requireContains('crates/rustok-installer-cli/src/lib.rs', 'execute_install_apply(&ports', 'installer CLI uses the shared apply state machine');
requireContains('crates/rustok-installer-cli/src/lib.rs', 'SeaOrmInstallerApplyPorts::new', 'installer CLI composes the standalone SeaORM apply adapter');
requireContains('crates/rustok-installer-cli/src/lib.rs', 'SeaOrmInstallerBootstrapPorts::new', 'installer CLI composes the shared SeaORM seed adapter');
requireNotContains('crates/rustok-installer-cli/src/lib.rs', 'ModuleLifecycleDbWriter::new', 'installer CLI does not duplicate module lifecycle persistence');
