...
for (const filePath of [corePath, transportPath, uiPath, detailUiPath, oauthUiPath, loginUiPath, registerUiPath, resetUiPath, profileUiPath, modelPath, i18nPath, planPath, registryPath, packagePath]) {
...
for (const marker of ["user_list_page", "user_list_query_params", "prepare_create_user_input", "prepare_update_user_input", "CreateUserInputError", "oauth_app_type_defaults", "prepare_create_oauth_app_input", "prepare_update_oauth_app_input", "format_oauth_app_timestamp", "prepare_login_request", "prepare_register_request", "prepare_password_reset_request", "prepare_profile_name", "classify_profile_update_error", "ProfileUpdateErrorKind"]) {
...
assertContains(profileUi, "classify_profile_update_error", `${profileUiPath}: profile UI must consume core error classification`);
