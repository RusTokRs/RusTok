...
const files = {
  composition: "crates/modules/rustok-groups/src/applications.rs",
  review: "crates/modules/rustok-groups/src/applications_review.rs",
  owner: "crates/modules/rustok-groups/src/applications_bulk_review.rs",
  graphqlRoot: "crates/modules/rustok-groups/src/graphql_application_cas.rs",
  graphql: "crates/modules/rustok-groups/src/graphql_application_bulk_review.rs",
  ports: "crates/modules/rustok-groups/src/ports.rs",
  fbaRegistry: "crates/modules/rustok-groups/contracts/groups-fba-registry.json",
  adminCore: "crates/modules/rustok-groups/admin/src/application_bulk_core.rs",
  adminModel: "crates/modules/rustok-groups/admin/src/application_bulk_model.rs",
  adminTransport: "crates/modules/rustok-groups/admin/src/application_bulk_transport.rs",
  nativeAdapter: "crates/modules/rustok-groups/admin/src/transport/native_application_bulk_review_adapter.rs",
