...
const paths = {
  contract: "crates/modules/rustok-forum/contracts/forum-topic-merge-owner.json",
  crossContract: "crates/modules/rustok-forum/contracts/forum-topic-merge-cross-category.json",
  solutionContract: "crates/modules/rustok-forum/contracts/forum-topic-merge-solution-policy.json",
  resolutionContract: "crates/modules/rustok-forum/contracts/forum-topic-merge-solution-resolution.json",
  canonicalContract: "crates/modules/rustok-forum/contracts/forum-topic-canonical-resolution.json",
  graphqlContract: "crates/modules/rustok-forum/contracts/forum-topic-merge-graphql-transport.json",
  adminContract: "crates/modules/rustok-forum/contracts/forum-topic-merge-admin-ui.json",
  docs: "crates/modules/rustok-forum/docs/forum-21b-topic-merge-owner.md",
  crossDocs: "crates/modules/rustok-forum/docs/forum-21m-topic-merge-cross-category.md",
  adminDocs: "crates/modules/rustok-forum/docs/forum-21n-topic-merge-admin-ui.md",
  receiptEntity: "crates/modules/rustok-forum/src/entities/forum_topic_merge_operation.rs",
  resolutionEntity:
    "crates/modules/rustok-forum/src/entities/forum_topic_merge_solution_resolution.rs",
  error: "crates/modules/rustok-forum/src/error.rs",
  receiptMigration:
    "crates/modules/rustok-forum/src/migrations/m20260801_000010_add_forum_topic_merge_operations.rs",
  solutionMigration:
    "crates/modules/rustok-forum/src/migrations/m20260803_000016_add_forum_topic_merge_solution_policy.rs",
  canonicalMigration:
    "crates/modules/rustok-forum/src/migrations/m20260803_000017_add_forum_topic_canonical_resolution.rs",
  resolutionMigration:
  ...
  service: "crates/modules/rustok-forum/src/services/topic_merge.rs",
  stats: "crates/modules/rustok-forum/src/services/user_stats.rs",
  canonicalService: "crates/modules/rustok-forum/src/services/topic_canonical_resolution.rs",
  facade: "crates/modules/rustok-forum/src/services/topic_facade.rs",
  redirect: "crates/modules/rustok-forum/src/controllers/topic_redirect.rs",
  ...
  crossTest: "crates/modules/rustok-forum/tests/topic_merge_cross_category_sqlite.rs",
  resolutionTest: "crates/modules/rustok-forum/tests/topic_merge_solution_resolution_sqlite.rs",
  canonicalTest: "crates/modules/rustok-forum/tests/topic_canonical_resolution_sqlite.rs",
  graphqlTest: "crates/modules/rustok-forum/tests/topic_merge_graphql_contract.rs",
  resolutionGraphqlTest:
    "crates/modules/rustok-forum/tests/topic_merge_solution_resolution_graphql_contract.rs",
  leptosModel: "crates/modules/rustok-forum/admin/src/topic_merge_model.rs",
  leptosUi: "crates/modules/rustok-forum/admin/src/ui/topic_merge.rs",
