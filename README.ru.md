...
*Универсальная платформа данных · Enterprise бэкенд · ИИ-Native · Модульная архитектура · Единый рантайм*
...
### 1. Универсальное ядро (Стартапы, SaaS, ERP, CRM, Финтех и Банкинг)
Ядро **RusTok Core** (`rustok-core`, `tenant`, `auth`, `rbac`, `index`, `search`, `outbox`, `cache`, `secrets`, `alloy`) — это универсальный фундамент промышленного уровня для **любых систем, работающих с данными**.
