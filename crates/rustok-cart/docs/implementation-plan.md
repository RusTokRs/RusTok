...
`rustok-cart` — scoped-подмодуль ecommerce family. Локальный план нужен для единого формата модульной документации; orchestration-контекст и cross-module roadmap остаются в umbrella-плане `rustok-commerce`.
