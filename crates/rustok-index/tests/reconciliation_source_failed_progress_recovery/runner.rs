...
use super::{
    ...
    source::SourceFailedProgressSource,
};

pub const SOURCE_NAME: &str = "source-failed-progress-recovery-primary";
...
pub fn runner(
    ...
    schema_catalog
        .register("source-failed-progress-recovery-harness", schema.clone())
        .expect("fixture schema source must register");

    let mut source_catalog = IndexSourceCatalog::new();
    source_catalog
        .register(
            "source-failed-progress-recovery-harness",
            SOURCE_NAME,
