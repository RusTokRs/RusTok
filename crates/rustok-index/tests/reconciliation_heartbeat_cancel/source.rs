...
#[derive(Clone)]
pub enum HeartbeatCancelSource {
    Blocking {
...
#[async_trait]
impl IndexSource for HeartbeatCancelSource {
    async fn scan(
        &self,
        ...
        match offset {
            0 => {
                ...
                IndexSourcePage::new(
                    &request,
                    vec![mutation(request.tenant_id(), 501, 12_501)],
                    Some(cursor),
                )
            ...
            1 => {
                ...
                IndexSourcePage::new(
                    &request,
                    vec![mutation(request.tenant_id(), 502, 12_502)],
                    None,
                )
                .map_err(|_| fixture_failure())
            }
...
fn fixture_failure() -> IndexSourceFailure {
    IndexSourceFailure::permanent("heartbeat_cancel_fixture_invalid")
