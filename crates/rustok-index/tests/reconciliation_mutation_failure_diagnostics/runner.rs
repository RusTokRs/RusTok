...
use super::{
    ...
    source::MutationFailureSource,
};

pub const SOURCE_NAME: &str = "mutation-failure-diagnostics-primary";
...
pub fn runner(
    ...
    schema_catalog
        .register("mutation-failure-diagnostics-harness", schema.clone())
        .expect("fixture schema source must register");

    let mut source_catalog = IndexSourceCatalog::new();
    source_catalog
        .register(
            "mutation-failure-diagnostics-harness",
            SOURCE_NAME,
