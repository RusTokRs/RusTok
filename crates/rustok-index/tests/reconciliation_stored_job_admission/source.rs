...
#[async_trait]
impl IndexSource for CountedSource {
    async fn scan(
        &self,
        ...
        match offset {
            0 => {
                ...
                IndexSourcePage::new(
                    &request,
                    vec![valid_mutation(request.tenant_id(), 1_101, 16_101)],
                    Some(cursor),
                )
            ...
            1 => IndexSourcePage::new(
                &request,
                vec![valid_mutation(request.tenant_id(), 1_102, 16_102)],
                None,
            )
            .map_err(|_| fixture_failure()),
...
fn fixture_failure() -> IndexSourceFailure {
    IndexSourceFailure::permanent("stored_job_admission_fixture_invalid")
