...
use super::{
    ...
    source::StaleVersionSource,
};

pub const SOURCE_NAME: &str = "stale-version-guard-primary";
...
pub fn runner(
    ...
    schema_catalog
        .register("stale-version-guard-harness", schema.clone())
