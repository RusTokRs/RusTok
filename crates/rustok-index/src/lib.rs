...
pub use infrastructure::postgres::{
    ...
    IndexOrphanLinkRemovalOutcome, IndexQueryRuntimeCompositionError,
    ...
    IndexReconciliationRunStatus, IndexReconciliationSchedulerCompositionError,
    IndexReconciliationSchedulerPolicy, IndexReconciliationTerminalState,
    ...
    MutationDelivery, MutationStorageError, PartitionAdmissionError,
    PartitionAdmissionOutcome, PartitionAdmissionPolicy, PartitionAdmissionReason,
    PartitionBaselineEvidence, PartitionEvidence, PartitionMeasurementCoverage,
    PartitionRelationPlan, PartitionShadowEvidence, PartitionShadowPlan, PartitionStrategy,
    PersistedSchemaRegistrationOutcome, PostgresIndexDriftCandidateMaterializedObserver,
    PostgresIndexDriftCandidateReader, PostgresIndexDriftConfirmedCandidateWriter,
    PostgresIndexDriftFindingLifecycleStore, PostgresIndexDriftMissingEntityEvidenceReader,
    PostgresIndexDriftMissingEntityRepairOwner, PostgresIndexDriftOrphanLinkEvidenceReader,
    PostgresIndexDriftOrphanLinkRepairOwner, PostgresIndexDriftRepairRecoveryStore,
    PostgresIndexDriftRepairStore, PostgresIndexDriftSnapshotReader,
    PostgresIndexOrphanLinkMutationStore, PostgresIndexQueryPort,
