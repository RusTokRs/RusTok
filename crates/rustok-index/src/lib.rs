...
pub use infrastructure::postgres::{
    evaluate_partition_admission, materialize_postgres_index_drift_snapshot_reader,
    materialize_postgres_index_query_runtime, materialize_postgres_index_replay_runtime,
    materialize_postgres_index_sources, register_postgres_index_reconciliation_work,
    register_postgres_index_source_factory, IndexDriftSnapshotCompositionError,
    ...
    PersistedSchemaRegistrationOutcome, PostgresIndexDriftSnapshotReader,
