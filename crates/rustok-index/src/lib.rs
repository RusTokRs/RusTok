...
pub use infrastructure::postgres::{
    evaluate_partition_admission, materialize_postgres_index_drift_candidate_reader,
    ...
    IndexDriftCandidateCompositionError, IndexDriftSnapshotCompositionError,
    ...
    IndexReconciliationRunError, IndexReconciliationRunOutcome, IndexReconciliationRunRequest,
    ...
    PersistedSchemaRegistrationOutcome, PostgresIndexDriftCandidateReader,
