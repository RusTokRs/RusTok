...
pub use infrastructure::postgres::{
    ...
    IndexSchemaReadinessFailure, IndexSchemaReadinessReceipt, IndexSchemaReadinessRequest,
    MutationApplyOutcome, MutationDelivery, MutationStorageError,
    ...
    PersistedSchemaSupersessionOutcome, PostgresIndexDriftCandidateMaterializedObserver,
    ...
    PostgresIndexQueryAdmissionError, PostgresIndexQueryPort,
    PostgresIndexSchemaReadinessStore, PostgresIndexReconciliationRetryStore,
    ...
    PostgresSecondaryIndexManager, RecoveryAwareIndexDriftRepairOwner,
    RecoveryAwareIndexDriftRepairStore, SchemaApplicationLease, SchemaApplicationLeaseRequest,
