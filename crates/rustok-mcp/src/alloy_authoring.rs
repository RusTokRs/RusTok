...
pub use alloy::{
    ...
    ChangeAlloyDeletedEvidenceRetentionCommand, ChangeAlloyScriptLifecycleCommand,
    CreateAlloyScriptCommand, DeleteAlloyScriptCommand, DeletedAlloyScript,
    GetAlloyDeletedEvidenceRetentionCommand, GetAlloyScriptCommand, ListAlloyScriptReviewsCommand,
    ListAlloyScriptRevisionsCommand, ListAlloyScriptsCommand, RedactedAlloyEvidenceRetention,
...
pub const TOOL_ALLOY_GET_DELETED_EVIDENCE_RETENTION: &str = "alloy_get_deleted_evidence_retention";
pub const TOOL_ALLOY_CHANGE_DELETED_EVIDENCE_RETENTION: &str =
...
/// The only remote MCP names that may invoke owner-bound Alloy authoring.
...
mod tests {
    ...
    #[test]
    fn owner_bound_authoring_tools_are_remote_only() {
