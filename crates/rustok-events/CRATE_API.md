...
### Domain Invariants
- Every event validates before envelope creation and again after durable/streaming deserialization.
...
- `EventValidationError` and `EventContractEnvelopeError` define stable validation classes.
