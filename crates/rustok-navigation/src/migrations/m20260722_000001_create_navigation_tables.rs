    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        if count != 0 {
            return Err(DbErr::Custom(
                "navigation migration found a partial menu table set".to_string(),
            ));
        }
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(MenuTranslations::Name)
                            .string_len(255)
                            .not_null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_menu_translations_tenant_menu")
                            .from(MenuTranslations::Table, MenuTranslations::TenantId)
                            .from_col(MenuTranslations::MenuId)
        ...
        manager
            .create_index(
                Index::create()
                    .name("uq_menu_translations_tenant_menu_locale")
                    .table(MenuTranslations::Table)
                    .col(MenuTranslations::TenantId)
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_menu_items_tenant_menu")
                            .from(MenuItems::Table, MenuItems::TenantId)
                            .from_col(MenuItems::MenuId)
                            .to(Menus::Table, Menus::TenantId)
                            .to_col(Menus::Id)
                            .on_update(ForeignKeyAction::Cascade)
                            .on_delete(ForeignKeyAction::Cascade),
        ...
        manager
            .create_index(
                Index::create()
                    .name("uq_menu_items_tenant_menu_id")
                    .table(MenuItems::Table)
                    .col(MenuItems::TenantId)
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(MenuItemTranslations::TenantId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MenuItemTranslations::MenuId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_menu_item_translations_tenant_item")
                            .from(MenuItemTranslations::Table, MenuItemTranslations::TenantId)
                            .from_col(MenuItemTranslations::MenuId)
                            .from_col(MenuItemTranslations::MenuItemId)
                            .to(MenuItems::Table, MenuItems::TenantId)
                            .to_col(MenuItems::MenuId)
                            .to_col(MenuItems::Id)
                            .on_update(ForeignKeyAction::Cascade)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("uq_menu_item_translations_tenant_menu_item_locale")
                    .table(MenuItemTranslations::Table)
                    .col(MenuItemTranslations::TenantId)
                    .col(MenuItemTranslations::MenuId)
