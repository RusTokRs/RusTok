use rustok_module_manifest::normalize_module_contribution_manifest;
use std::env;
use std::fs;
...
fn main() {
    ...
    let mut generated = String::from(
        "// @generated by rustok-pages-admin/build.rs through rustok-module-manifest from ../rustok-module.toml.\n// Do not edit by hand.\n\n",
    );
