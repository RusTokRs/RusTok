...
if (gate.current_boundary?.four_profile_runtime_matrix !== "source_executable_evidence_pending") failures.push("four-profile runtime matrix must remain evidence pending");
...
console.log("[verify-pages-tenant-rollout-settings-runtime] PASS owner=pages_graphql bindings=ui+ssr+browser_intent runtime_matrix=evidence_pending");
