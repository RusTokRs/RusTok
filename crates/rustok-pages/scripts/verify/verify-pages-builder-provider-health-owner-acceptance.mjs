...
for (const marker of [
  ...
  "OWNER_ID_PATTERN_SOURCE",
  "must reside under repository target/",
  "repository target/ must be a real directory",
  "acceptance output must be a direct file inside repository target/",
  "owner acceptance source contract identity drifted",
  "owner acceptance source contract policy drifted",
  ...
  "deployment evaluator bounds are invalid",
