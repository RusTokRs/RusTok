...
impl SearchMutationRoot {
    ...
    async fn upsert_search_synonym(
        ...
        let synonym =
            SearchDictionaryService::upsert_synonym(db, tenant_id, &input.term, input.synonyms)
                .await
    ...
    async fn delete_search_synonym(
        ...
        SearchDictionaryService::delete_synonym(db, tenant_id, synonym_id)
            .await
            .map_err(map_search_module_error)?;
    ...
    async fn add_search_stop_word(
        ...
        let tenant_id =
            resolve_tenant_scope(tenant, parse_optional_uuid(input.tenant_id.as_deref())?)?;
        let stop_word = SearchDictionaryService::add_stop_word(db, tenant_id, &input.value)
            .await
            .map_err(map_search_module_error)?;
    ...
    async fn delete_search_stop_word(
        ...
        SearchDictionaryService::delete_stop_word(db, tenant_id, stop_word_id)
            .await
            .map_err(map_search_module_error)?;
    ...
    async fn delete_search_query_rule(
        ...
        SearchDictionaryService::delete_query_rule(db, tenant_id, query_rule_id)
            .await
            .map_err(map_search_module_error)?;
