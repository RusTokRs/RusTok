...
async fn forum_storefront_search_native(
    ...
    execute_forum_storefront_search_native(query, locale, preset_key, filters, Vec::new(), Vec::new(), None).await
}
...
async fn forum_storefront_search_by_authors_native(
    ...
    execute_forum_storefront_search_native(query, locale, preset_key, filters, author_ids, Vec::new(), None).await
}
