...
- Keeps preview and analytics summary presentation mapping in framework-agnostic core view-model helpers so the Leptos layer only renders prepared fields and host click actions.
