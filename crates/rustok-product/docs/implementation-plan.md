...
- Evidence:
  ...
  - FFA guardrail: `scripts/verify/verify-product-admin-boundary.mjs` added to the aggregate `verify:ffa:ui:migration` pipeline and checks product admin core/transport/ui split without long Cargo compilation;
