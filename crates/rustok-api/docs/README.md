...
- reusable read/write/event-replay/best-effort port enforcement без module-specific business logic; первый consumer migration slice закреплён в `rustok-region`;
