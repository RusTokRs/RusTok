...
- публиковать минимальные port primitives (`PortContext`, `PortError`) для новых transport-agnostic ports.

## Зона ответственности

- request context types, transport-agnostic port context/error primitives и auth/tenant/channel host contracts;
