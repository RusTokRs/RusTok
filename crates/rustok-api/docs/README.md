...
- reusable read/write/event-replay/best-effort port enforcement без module-specific business logic; consumer migration закреплена в `rustok-region` и продолжена для product, customer, media, workflow, RBAC, tax, fulfillment, payment, pricing, cart, inventory и comments read ports;
