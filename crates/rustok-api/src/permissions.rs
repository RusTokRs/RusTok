...
impl fmt::Display for Resource {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let value = match self {
            ...
            Self::ModerationCases => "moderation_cases",
...
impl FromStr for Resource {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            ...
            "moderation_cases" => Ok(Self::ModerationCases),
...
impl Permission {
    permission_constants! {
        ...
        MODERATION_CASES_READ => (ModerationCases, Read),
        MODERATION_CASES_LIST => (ModerationCases, List),
        MODERATION_CASES_OVERRIDE => (ModerationCases, Override),
        MODERATION_CASES_MANAGE => (ModerationCases, Manage),
