...
- `src/transport/native_server_adapter/raw_adapter.rs` — native payment collection/refund server-function adapter backed by `HostRuntimeContext` DB/event-bus handles; it has no Loco runtime or outbox Loco-adapter dependency.
