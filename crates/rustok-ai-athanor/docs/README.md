...
entities and lexical retrieval through Athanor's Tantivy-backed search. Vector
retrieval remains an explicit capability gap until Athanor Phase 9 ships a
concrete `VectorIndex` adapter.
