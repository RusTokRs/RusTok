...
- Selected-thread и locale route/query policy принадлежит `admin/src/core.rs`; Leptos adapter только применяет готовые push/replace/clear updates через host route-query writer.
