...
- Next step: Закрыть contract tests/fallback smoke для `InventoryReservationPort` и затем готовить повышение до `boundary_ready`; сохранить итерацию маленькой и не запускать долгую компиляцию.
