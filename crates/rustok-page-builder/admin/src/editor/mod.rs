...
mod contribution_preview;
mod contribution_properties;
...
pub(crate) use contribution_preview::ContributionPreviewPanel;
pub(crate) use contribution_properties::ContributionPropertiesPanel;
