    ...
    let post_id = post_service
        .create_post(
            ...
            CreatePostInput {
                ...
                content: rustok_blog::richtext::article_document_from_plain_text(&"Hello, Blog!".to_string()),
    ...
    let post = post_service
        .create_post(
            ...
            CreatePostInput {
                ...
                content: rustok_blog::richtext::article_document_from_plain_text(&"Post body".to_string()),
                excerpt: None,
                slug: None,
                publish: false,
                tags: vec![],
...
mod unit_tests {
    ...
    fn test_create_post_input_fields() {
        let input = CreatePostInput {
            ...
            content: rustok_blog::richtext::article_document_from_plain_text(&"Тело поста".to_string()),
