...
- Current phase: ffa_admin_body_format_warning_core_boundary
- Last checkpoint: FFA slice #89 moved admin body-format raw-warning visibility/message envelope into `BlogPostAdminBodyFormatWarningViewModel`, so the Leptos adapter only binds the prepared warning payload.
