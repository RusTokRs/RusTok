...
- Last checkpoint: FFA slice #101 moved admin edit-banner and raw-body warning CSS class selection into Leptos-free core helpers (`edit_banner_class`, `raw_body_warning_class`) and their view-models, so the Leptos adapter renders prepared presentation envelopes instead of owning those class policies.
...
- Last updated at (UTC): 2026-06-20T02:00:00Z
