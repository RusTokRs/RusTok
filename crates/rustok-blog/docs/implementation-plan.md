...
- Current phase: ffa_admin_delete_result_policy_core_boundary
- Last checkpoint: FFA slice #84 moved admin delete-result handling into `BlogPostDeleteResultViewModel`, so the Leptos adapter applies prepared refresh/reset/route-query instructions and receives typed false-delete issues from core.
