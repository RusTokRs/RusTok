...
3. **SEO projection** — Blog SEO description fallback still summarizes `PostResponse.body`.
4. **AI Blog draft writer** — direct Blog draft create/update commands still write Markdown and leave canonical `content` empty.
