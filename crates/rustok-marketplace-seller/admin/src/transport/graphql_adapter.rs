...
const DETAIL_QUERY: &str = "query MarketplaceSellerAdminDetail($id: UUID!) { seller: marketplaceSeller(id: $id) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } members: marketplaceSellerMembers(sellerId: $id) { id seller_id: sellerId user_id: userId role status invited_by_actor_id: invitedByActorId accepted_at: acceptedAt metadata created_at: createdAt updated_at: updatedAt } }";
const CREATE_MUTATION: &str = "mutation MarketplaceSellerAdminCreate($idempotencyKey: String!, $input: MarketplaceSellerCreateInputGql!) { result: createMarketplaceSeller(idempotencyKey: $idempotencyKey, input: $input) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
const UPDATE_PROFILE_MUTATION: &str = "mutation MarketplaceSellerAdminUpdateProfile($idempotencyKey: String!, $sellerId: UUID!, $input: MarketplaceSellerProfileInputGql!) { result: updateMarketplaceSellerProfile(idempotencyKey: $idempotencyKey, sellerId: $sellerId, input: $input) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
const SUBMIT_MUTATION: &str = "mutation MarketplaceSellerAdminSubmit($idempotencyKey: String!, $sellerId: UUID!, $note: String) { result: submitMarketplaceSellerOnboarding(idempotencyKey: $idempotencyKey, sellerId: $sellerId, note: $note) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
const REVIEW_MUTATION: &str = "mutation MarketplaceSellerAdminReview($idempotencyKey: String!, $sellerId: UUID!, $approved: Boolean!, $note: String) { result: reviewMarketplaceSellerOnboarding(idempotencyKey: $idempotencyKey, sellerId: $sellerId, approved: $approved, note: $note) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
const SUSPEND_MUTATION: &str = "mutation MarketplaceSellerAdminSuspend($idempotencyKey: String!, $sellerId: UUID!, $reason: String!) { result: suspendMarketplaceSeller(idempotencyKey: $idempotencyKey, sellerId: $sellerId, reason: $reason) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
const REACTIVATE_MUTATION: &str = "mutation MarketplaceSellerAdminReactivate($idempotencyKey: String!, $sellerId: UUID!) { result: reactivateMarketplaceSeller(idempotencyKey: $idempotencyKey, sellerId: $sellerId) { id tenant_id: tenantId handle display_name: displayName legal_name: legalName status onboarding_status: onboardingStatus onboarding_note: onboardingNote suspension_reason: suspensionReason metadata created_at: createdAt updated_at: updatedAt activated_at: activatedAt suspended_at: suspendedAt } }";
