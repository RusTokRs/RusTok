...
schema v6 and Blog registry schema v15. Historical sections below that mention
...
The typed storefront comments availability is source-locked. Cached public-comment snapshots are source-implemented with revision-based invalidation. The remote transport remains pending.
