...
- Native price-list, variant-price and discount handlers use `HostRuntimeContext` DB access and its typed `TransactionalEventBus` handle; the package has no host-framework runtime dependency.
