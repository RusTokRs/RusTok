        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Alias::new("actor_user_id"))
                            .uuid()
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(Alias::new("request_fingerprint"))
                            .string_len(96)
                            .not_null(),
                    )
                    .col(ColumnDef::new(Alias::new("operation_id")).uuid().not_null())
                    .col(
                        ColumnDef::new(Alias::new("resource_revision"))
                            .string_len(96)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Alias::new("source_revision"))
                            .string_len(96)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Alias::new("target_revision"))
                            .string_len(96)
                            .not_null(),
                    )
                    .col(
