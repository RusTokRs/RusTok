...
const POLICIES_TABLE: &str = "flex_standalone_field_policies";
const SCHEMAS_TABLE: &str = "flex_schemas";
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .primary_key(
                        Index::create()
                            .name("pk_flex_standalone_field_policies")
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_flex_standalone_field_policies_schema")
                            .from(Alias::new(POLICIES_TABLE), Alias::new("schema_id"))
                            .to(Alias::new(SCHEMAS_TABLE), Alias::new("id"))
