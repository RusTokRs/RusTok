...
pub mod attached_value_translation;
...
pub use attached_value_translation::{
    FlexAttachedValueTranslationError, FlexAttachedValueTranslationExactLocaleApply,
    FlexAttachedValueTranslationExactLocaleApplyReceipt,
    FlexAttachedValueTranslationExactLocaleSnapshot, FlexAttachedValueTranslationLeaf,
    FlexAttachedValueTranslationLeafSnapshot, FlexAttachedValueTranslationOperationContext,
    FlexAttachedValueTranslationOwnerPort, FlexAttachedValueTranslationResourceId,
    FlexAttachedValueTranslationResourcePage, FlexAttachedValueTranslationResult,
    FlexAttachedValueTranslationTargetValue, MAX_FLEX_ATTACHED_VALUE_TRANSLATION_RESOURCE_PAGE,
    build_flex_attached_value_translation_snapshot,
    flex_attached_value_translation_definition_eligible,
    flex_attached_value_translation_definitions,
    validate_flex_attached_value_translation_resource_page,
};
pub use entity_type::{
