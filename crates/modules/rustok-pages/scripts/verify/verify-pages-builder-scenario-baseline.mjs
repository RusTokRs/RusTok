...
const [
  ...
  read('crates/modules/rustok-pages/Cargo.toml'),
  read('crates/modules/rustok-pages/src/entities/mod.rs'),
  ...
  read('crates/modules/rustok-pages/src/migrations/m20260714_000001_create_page_builder_scenario_baselines.rs'),
  read('crates/modules/rustok-pages/src/services/mod.rs'),
  read('crates/modules/rustok-pages/src/services/scenario_baseline.rs'),
  read('crates/modules/rustok-pages/src/services/page/lifecycle.rs'),
  read('crates/modules/rustok-pages/src/services/page/reviewed_publish.rs'),
  read('crates/modules/rustok-pages/src/services/page/document.rs'),
  read('crates/modules/rustok-pages/src/graphql/mod.rs'),
  read('crates/modules/rustok-pages/src/graphql/scenario_baseline.rs'),
  read('crates/modules/rustok-pages/src/graphql/mutation.rs'),
  read('crates/modules/rustok-pages/admin/src/model.rs'),
  read('crates/modules/rustok-pages/admin/src/transport/graphql_adapter.rs'),
  read('crates/modules/rustok-pages/admin/src/transport/scenario_baseline_cas_adapter.rs'),
  read('crates/modules/rustok-pages/admin/src/transport/scenario_release_adapter.rs'),
  read('crates/modules/rustok-pages/admin/src/transport/mod.rs'),
  read('crates/modules/rustok-pages/admin/src/composition.rs'),
