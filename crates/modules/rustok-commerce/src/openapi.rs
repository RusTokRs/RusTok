...
#[openapi(
    ...
    components(
        schemas(
            ...
            rustok_product::dto::VariantAxisInput,
            rustok_product::dto::VariantAxisConfigResponse,
            rustok_product::dto::AxisAllowedValueResponse,
            rustok_product::dto::VariantAxisValueResponse,
            rustok_product::dto::VariantAxisValueInput,
            rustok_product::dto::SetVariantAxesInput,
