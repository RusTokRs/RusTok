        ...
        let statements: &[&str] = match manager.get_database_backend() {
            DbBackend::Postgres => &[
                "CREATE TABLE module_artifact_data_copy_operations (\
                    ...
                    UNIQUE (tenant_id, data_owner_id, source_namespace_instance_id, target_namespace_instance_id, idempotency_key)\
                )",
                "CREATE INDEX idx_artifact_data_copy_ops_scope \
                 ON module_artifact_data_copy_operations (tenant_id, data_owner_id, source_namespace_instance_id, target_namespace_instance_id, status)",
