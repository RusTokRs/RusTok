...
const [
  ...
  read('crates/ui/fly/src/validation.rs'),
  read('crates/ui/fly/src/context_schema.rs'),
  read('crates/ui/fly/src/context_contract.rs'),
  read('crates/ui/fly/src/context_compatibility.rs'),
  read('crates/ui/fly/src/context_dependency.rs'),
  read('crates/ui/fly/src/context_json_schema.rs'),
  read('crates/ui/fly/src/context_migration.rs'),
  read('crates/ui/fly/src/runtime_gate.rs'),
  read('crates/ui/fly/src/runtime_pipeline.rs'),
  read('crates/ui/fly/src/runtime_scenario_render.rs'),
  read('crates/ui/fly/src/runtime_scenario_snapshot.rs'),
  read('crates/modules/rustok-page-builder/src/lib.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_context.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_context_compatibility.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_context_dependency.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_context_migration.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_scenario_render.rs'),
  read('crates/modules/rustok-page-builder/src/runtime_scenario_snapshot.rs'),
  read('crates/modules/rustok-page-builder/admin/src/editor/mod.rs'),
  read('crates/modules/rustok-page-builder/admin/src/editor/modular_canvas.rs'),
  read('crates/modules/rustok-page-builder/admin/src/editor/context_schema_panel.rs'),
  read('crates/modules/rustok-page-builder/admin/src/editor/runtime_scenario_matrix.rs'),
