...
const providerManifest = path.join(repoRoot, "crates", "modules", "rustok-page-builder", "rustok-module.toml");
const consumerManifest = path.join(repoRoot, "crates", "modules", crateName, "rustok-module.toml");
