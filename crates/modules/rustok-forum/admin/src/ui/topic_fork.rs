...
#[cfg(test)]
mod tests {
    use super::forum_topic_fork_content_lang;

    #[test]
    fn fork_target_content_lang_uses_shared_locale_normalization() {
        assert_eq!(forum_topic_fork_content_lang("ar_sa"), "ar-SA");
        assert_eq!(forum_topic_fork_content_lang("pt_br"), "pt-BR");
    }

    #[test]
    fn fork_target_content_lang_fails_closed_for_invalid_locale() {
        assert_eq!(forum_topic_fork_content_lang("not a locale"), "und");
    }
}
