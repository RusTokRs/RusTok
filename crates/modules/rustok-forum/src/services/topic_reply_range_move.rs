...
impl ForumReplyRangeMoveService {
    ...
    pub async fn move_reply_range(
        ...
        let move_params = TopicReplyRangeMoveOperationParams {
            source_topic_id,
            ...
            source_resulting_published_reply_count,
            target_resulting_published_reply_count,
            moved_solution_reply_id: moved_solution.as_ref().map(|solution| solution.reply_id),
            source_resulting_solution_reply_id,
            target_resulting_solution_reply_id,
        };

        let payload = event_payload(&move_params);
...
struct TopicReplyRangeMoveOperationParams<'a> {
    source_topic_id: Uuid,
    source_category_id: Uuid,
    target_category_id: Uuid,
    actor_id: Uuid,
    prepared: &'a PreparedRangeMoveInput,
    target_start_position: i64,
    target_end_position: i64,
    moved_reply_count: i32,
    moved_published_reply_count: i32,
...
fn event_payload(params: &TopicReplyRangeMoveOperationParams<'_>) -> JsonValue {
    json!({
        "operation_id": params.prepared.operation_id,
        "source_topic_id": params.source_topic_id,
        "target_topic_id": params.prepared.target_topic_id,
        "source_category_id": params.source_category_id,
        "target_category_id": params.target_category_id,
        "actor_id": params.actor_id,
        "reason": params.prepared.reason,
        "command_fingerprint": params.prepared.command_fingerprint,
        "source_start_position": params.prepared.start_position,
        "source_end_position": params.prepared.end_position,
        "target_start_position": params.target_start_position,
        "target_end_position": params.target_end_position,
        "moved_reply_count": params.moved_reply_count,
        "moved_published_reply_count": params.moved_published_reply_count,
        "source_resulting_published_reply_count": params.source_resulting_published_reply_count,
        "target_resulting_published_reply_count": params.target_resulting_published_reply_count,
        "moved_solution_reply_id": params.moved_solution_reply_id,
        "source_resulting_solution_reply_id": params.source_resulting_solution_reply_id,
        "target_resulting_solution_reply_id": params.target_resulting_solution_reply_id,
...
async fn insert_operation_in_tx(
    txn: &DatabaseTransaction,
    tenant_id: Uuid,
    params: &TopicReplyRangeMoveOperationParams<'_>,
    now: DateTime<Utc>,
) -> ForumResult<()> {
    ...
    txn.execute_raw(Statement::from_sql_and_values(
        ...
        vec![
            tenant_id.into(),
            params.prepared.operation_id.into(),
            params.source_topic_id.into(),
            params.prepared.target_topic_id.into(),
            params.source_category_id.into(),
            params.target_category_id.into(),
            params.actor_id.into(),
            params.prepared.reason.clone().into(),
            params.prepared.command_fingerprint.clone().into(),
            params.prepared.start_position.into(),
            params.prepared.end_position.into(),
            params.target_start_position.into(),
            params.target_end_position.into(),
            params.moved_reply_count.into(),
            params.moved_published_reply_count.into(),
            params.source_resulting_published_reply_count.into(),
            params.target_resulting_published_reply_count.into(),
            params.moved_solution_reply_id.into(),
            params.source_resulting_solution_reply_id.into(),
            params.target_resulting_solution_reply_id.into(),
            params.prepared.operation_id.into(),
            now.into(),
        ],
    ))
