...
fn sample_events() -> Vec<DomainEvent> {
    vec![
        ...
        DomainEvent::TranslationTargetChanged {
            ...
            resource_id: id(18).to_string(),
            changed_locale: "fr".to_string(),
            resource_revision: "resource-1".to_string(),
            target_revision: "1".to_string(),
            operation: "upsert".to_string(),
            correlation_id: "translation-apply-1".to_string(),
        },
        ...
        DomainEvent::ModuleStaticDistributionBuildCompleted {
            ...
            bundle_root_digest: Some(digest('d')),
            role_set_digest: Some(digest('e')),
