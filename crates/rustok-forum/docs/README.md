...
- expose the idempotent same-category topic merge owner through routed-tenant, `forum_topics:manage` GraphQL commands that return the immutable owner receipt;
...
- targeted tests for topic/reply lifecycle, moderation, votes, subscriptions,
  ...
  manager-only merge GraphQL composition and explicit competing-solution resolution;
