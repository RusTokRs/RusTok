...
VALUES
    ('{}', '{tenant_b}', '{topic_a}', 'en', 'Wrong tenant', 'Body')
"#,
            Uuid::new_v4()
        ),
...
VALUES
    ('{}', '{tenant_b}', '{reply_a}', 'en', 'Wrong tenant')
"#,
            Uuid::new_v4()
        ),
...
INSERT INTO forum_topic_translations
    (id, tenant_id, topic_id, locale, title, body)
VALUES
    ('{}', '{tenant_a}', '{topic_a}', 'en', 'Valid', 'Body')
"#,
            Uuid::new_v4()
        ),
    )
