...
[1m[91merror[E0425][0m[1m: cannot find value `GRAPESJS_FORMAT` in this scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:414:38
    [1m[94m|[0m
[1m[94m414[0m [1m[94m|[0m         FlyProjectInspection::decode(GRAPESJS_FORMAT, &baseline())
    [1m[94m|[0m                                      [1m[91m^^^^^^^^^^^^^^^[0m [1m[91mnot found in this scope[0m

[1m[91merror[E0061][0m[1m: this function takes 1 argument but 2 arguments were supplied[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:414:9
    [1m[94m|[0m
[1m[94m414[0m [1m[94m|[0m         FlyProjectInspection::decode(GRAPESJS_FORMAT, &baseline())
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[94m---------------[0m [1m[94munexpected argument #1[0m
    [1m[94m|[0m
[1m[92mnote[0m: associated function defined here
   [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:39:12
    [1m[94m|[0m
[1m[94m 39[0m [1m[94m|[0m     pub fn decode(project_data: &Value) -> FlyProjectAdapterResult<Self> {
    [1m[94m|[0m            [1m[92m^^^^^^[0m
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m414[0m [91m- [0m        FlyProjectInspection::decode([91mGRAPESJS_FORMAT, [0m&baseline())
[1m[94m414[0m [92m+ [0m        FlyProjectInspection::decode(&baseline())
    [1m[94m|[0m

[1m[91merror[E0599][0m[1m: no variant named `UnsupportedSchema` found for enum `adapters::FlyProjectAdapterError`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:424:37
    [1m[94m|[0m
[1m[94m150[0m [1m[94m|[0m pub enum FlyProjectAdapterError {
    [1m[94m|[0m [1m[94m-------------------------------[0m [1m[94mvariant `UnsupportedSchema` not found here[0m
[1m[94m...[0m
[1m[94m424[0m [1m[94m|[0m             FlyProjectAdapterError::UnsupportedSchema { .. }
    [1m[94m|[0m                                     [1m[91m^^^^^^^^^^^^^^^^^[0m [1m[91mvariant not found in `adapters::FlyProjectAdapterError`[0m

[1m[91merror[E0560][0m[1m: struct `rollout::BuilderCapabilityFlags` has no field named `legacy_bridge_readonly`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:913:13
    [1m[94m|[0m
[1m[94m913[0m [1m[94m|[0m             legacy_bridge_readonly: false,
    [1m[94m|[0m             [1m[91m^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91m`rollout::BuilderCapabilityFlags` does not have this field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: all struct fields are already assigned

[1m[91merror[E0609][0m[1m: no field `contract` on type `runtime_telemetry::PageBuilderRuntimeCallEvidence`[0m
    [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:1304:29
     [1m[94m|[0m
[1m[94m1304[0m [1m[94m|[0m         assert_eq!(evidence.contract, "grapesjs");
     [1m[94m|[0m                             [1m[91m^^^^^^^^[0m [1m[91munknown field[0m
     [1m[94m|[0m
     [1m[94m= [0m[1mnote[0m: available fields are: `module_slug`, `operation`, `status`, `tenant_id`, `page_id` ... and 4 others

[1m[91merror[E0433][0m[1m: cannot find type `PageBuilderAdapterCallStatus` in this scope[0m
    [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:1306:37
     [1m[94m|[0m
[1m[94m1306[0m [1m[94m|[0m         assert_eq!(evidence.status, PageBuilderAdapterCallStatus::Started);
     [1m[94m|[0m                                     [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91muse of undeclared type `PageBuilderAdapterCallStatus`[0m

[1m[91merror[E0433][0m[1m: cannot find type `PageBuilderAdapterCallStatus` in this scope[0m
    [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:1315:35
     [1m[94m|[0m
[1m[94m1315[0m [1m[94m|[0m         assert_eq!(failed.status, PageBuilderAdapterCallStatus::Failed);
     [1m[94m|[0m                                   [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91muse of undeclared type `PageBuilderAdapterCallStatus`[0m

[1m[91merror[E0425][0m[1m: cannot find type `NoopPageBuilderAdapterTelemetry` in module `rustok_page_builder::service`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/tests/runtime_scenario_release.rs:133:39
    [1m[94m|[0m
[1m[94m133[0m [1m[94m|[0m         rustok_page_builder::service::NoopPageBuilderAdapterTelemetry,
    [1m[94m|[0m                                       [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
    [1m[94m|[0m
   [1m[94m::: [0mcrates/rustok-page-builder/src/runtime_telemetry.rs:122:1
    [1m[94m|[0m
[1m[94m122[0m [1m[94m|[0m pub struct NoopPageBuilderRuntimeTelemetry;
    [1m[94m|[0m [1m[94m------------------------------------------[0m [1m[94msimilarly named struct `NoopPageBuilderRuntimeTelemetry` defined here[0m
    [1m[94m|[0m
[1m[96mhelp[0m: a struct with a similar name exists
    [1m[94m|[0m
[1m[94m133[0m [91m- [0m        rustok_page_builder::service::[91mNoopPageBuilderAdapterTelemetry[0m,
[1m[94m133[0m [92m+ [0m        rustok_page_builder::service::[92mNoopPageBuilderRuntimeTelemetry[0m,
    [1m[94m|[0m

[1mFor more information about this error, try `rustc --explain E0425`.[0m
[1m[91merror[0m: could not compile `rustok-page-builder` (test "runtime_scenario_release") due to 1 previous error
[1m[33mwarning[0m: build failed, waiting for other jobs to finish...
[1mSome errors have detailed explanations: E0061, E0425, E0433, E0560, E0599, E0609.[0m
[1mFor more information about an error, try `rustc --explain E0061`.[0m
[1m[91merror[0m: could not compile `rustok-page-builder` (lib test) due to 7 previous errors
```
