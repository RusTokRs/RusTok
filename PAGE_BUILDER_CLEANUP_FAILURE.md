...
[1m[91merror[E0425][0m[1m: cannot find value `schema_version` in this scope[0m
  [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:83:12
   [1m[94m|[0m
[1m[94m83[0m [1m[94m|[0m         if schema_version != GRAPESJS_FORMAT {
   [1m[94m|[0m            [1m[91m^^^^^^^^^^^^^^[0m [1m[91mnot found in this scope[0m

[1m[91merror[E0425][0m[1m: cannot find value `schema_version` in this scope[0m
  [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:86:25
   [1m[94m|[0m
[1m[94m86[0m [1m[94m|[0m                 actual: schema_version.to_string(),
   [1m[94m|[0m                         [1m[91m^^^^^^^^^^^^^^[0m [1m[91mnot found in this scope[0m

[1m[91merror[E0599][0m[1m: no variant named `UnsupportedSchema` found for enum `FlyProjectAdapterError`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/adapters.rs:84:48
    [1m[94m|[0m
[1m[94m 84[0m [1m[94m|[0m             return Err(FlyProjectAdapterError::UnsupportedSchema {
    [1m[94m|[0m                                                [1m[91m^^^^^^^^^^^^^^^^^[0m [1m[91mvariant not found in `FlyProjectAdapterError`[0m
[1m[94m...[0m
[1m[94m181[0m [1m[94m|[0m pub enum FlyProjectAdapterError {
    [1m[94m|[0m [1m[94m-------------------------------[0m [1m[94mvariant `UnsupportedSchema` not found here[0m

[1m[91merror[E0609][0m[1m: no field `schema_version` on type `PreviewPageBuilderInput`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:363:57
    [1m[94m|[0m
[1m[94m363[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m                                                         [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `page_id`, `project_data`

[1m[91merror[E0061][0m[1m: this function takes 2 arguments but 3 arguments were supplied[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:363:9
    [1m[94m|[0m
[1m[94m363[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^[0m                 [1m[94m---------------------[0m [1m[94munexpected argument #2[0m
    [1m[94m|[0m
[1m[92mnote[0m: function defined here
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:558:4
    [1m[94m|[0m
[1m[94m558[0m [1m[94m|[0m fn validate_project_payload(
    [1m[94m|[0m    [1m[92m^^^^^^^^^^^^^^^^^^^^^^^^[0m
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m363[0m [91m- [0m        validate_project_payload(&input.page_id[91m, &input.schema_version[0m, &input.project_data)?;
[1m[94m363[0m [92m+ [0m        validate_project_payload(&input.page_id, &input.project_data)?;
    [1m[94m|[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:365:24
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m365[0m [1m[94m|[0m         self.telemetry.record_adapter_call(&evidence);
    [1m[94m|[0m                        [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:372:32
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m372[0m [1m[94m|[0m                 self.telemetry.record_adapter_call(&evidence.succeeded());
    [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:376:32
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m376[0m [1m[94m|[0m                 self.telemetry.record_adapter_call(&evidence.failed(&error));
    [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:394:24
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m394[0m [1m[94m|[0m         self.telemetry.record_adapter_call(&evidence);
    [1m[94m|[0m                        [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:397:32
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m397[0m [1m[94m|[0m                 self.telemetry.record_adapter_call(&evidence.succeeded());
    [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:401:32
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m401[0m [1m[94m|[0m                 self.telemetry.record_adapter_call(&evidence.failed(&error));
    [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0609][0m[1m: no field `schema_version` on type `PublishPageBuilderInput`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:438:57
    [1m[94m|[0m
[1m[94m438[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m                                                         [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `page_id`, `revision_id`, `project_data`

[1m[91merror[E0061][0m[1m: this function takes 2 arguments but 3 arguments were supplied[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:438:9
    [1m[94m|[0m
[1m[94m438[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^[0m                 [1m[94m---------------------[0m [1m[94munexpected argument #2[0m
    [1m[94m|[0m
...
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m438[0m [91m- [0m        validate_project_payload(&input.page_id[91m, &input.schema_version[0m, &input.project_data)?;
[1m[94m438[0m [92m+ [0m        validate_project_payload(&input.page_id, &input.project_data)?;
    [1m[94m|[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:444:24
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m444[0m [1m[94m|[0m         self.telemetry.record_adapter_call(&evidence);
    [1m[94m|[0m                        [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:455:38
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m455[0m [1m[94m|[0m             Ok(()) => self.telemetry.record_adapter_call(&evidence.succeeded()),
    [1m[94m|[0m                                      [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0599][0m[1m: no method named `record_adapter_call` found for type parameter `T` in the current scope[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:457:32
    [1m[94m|[0m
[1m[94m352[0m [1m[94m|[0m impl<S, R, T> PageBuilderCapabilityService for AdapterBackedPageBuilderService<S, R, T>
    [1m[94m|[0m            [1m[94m-[0m [1m[94mmethod `record_adapter_call` not found for this type parameter[0m
[1m[94m...[0m
[1m[94m457[0m [1m[94m|[0m                 self.telemetry.record_adapter_call(&evidence.failed(&error));
    [1m[94m|[0m                                [1m[91m^^^^^^^^^^^^^^^^^^^[0m [1m[91mmethod not found in `T`[0m

[1m[91merror[E0609][0m[1m: no field `schema_version` on type `PreviewPageBuilderInput`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:505:57
    [1m[94m|[0m
[1m[94m505[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m                                                         [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `page_id`, `project_data`

[1m[91merror[E0061][0m[1m: this function takes 2 arguments but 3 arguments were supplied[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:505:9
    [1m[94m|[0m
[1m[94m505[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^[0m                 [1m[94m---------------------[0m [1m[94munexpected argument #2[0m
    [1m[94m|[0m
...
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m505[0m [91m- [0m        validate_project_payload(&input.page_id[91m, &input.schema_version[0m, &input.project_data)?;
[1m[94m505[0m [92m+ [0m        validate_project_payload(&input.page_id, &input.project_data)?;
    [1m[94m|[0m

[1m[91merror[E0609][0m[1m: no field `schema_version` on type `PublishPageBuilderInput`[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:548:57
    [1m[94m|[0m
[1m[94m548[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m                                                         [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `page_id`, `revision_id`, `project_data`

[1m[91merror[E0061][0m[1m: this function takes 2 arguments but 3 arguments were supplied[0m
   [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:548:9
    [1m[94m|[0m
[1m[94m548[0m [1m[94m|[0m         validate_project_payload(&input.page_id, &input.schema_version, &input.project_data)?;
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^[0m                 [1m[94m---------------------[0m [1m[94munexpected argument #2[0m
    [1m[94m|[0m
...
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m548[0m [91m- [0m        validate_project_payload(&input.page_id[91m, &input.schema_version[0m, &input.project_data)?;
[1m[94m548[0m [92m+ [0m        validate_project_payload(&input.page_id, &input.project_data)?;
    [1m[94m|[0m

[1mSome errors have detailed explanations: E0061, E0425, E0599, E0609.[0m
[1mFor more information about an error, try `rustc --explain E0061`.[0m
[1m[91merror[0m: could not compile `rustok-page-builder` (lib) due to 20 previous errors
```
