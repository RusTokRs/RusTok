...
[1m[91merror[E0433][0m[1m: cannot find type `ProjectFormat` in this scope[0m
   [1m[94m--> [0mcrates/fly/src/tests.rs:129:30
    [1m[94m|[0m
[1m[94m129[0m [1m[94m|[0m         serde_json::to_value(ProjectFormat::GrapesJs).expect("serialize"),
    [1m[94m|[0m                              [1m[91m^^^^^^^^^^^^^[0m [1m[91muse of undeclared type `ProjectFormat`[0m

[1mFor more information about this error, try `rustc --explain E0433`.[0m
[1m[91merror[0m: could not compile `fly` (lib test) due to 1 previous error
```
