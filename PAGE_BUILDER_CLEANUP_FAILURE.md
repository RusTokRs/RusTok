...
[1m[33mwarning[0m[1m: unused import: `Map`[0m
 [1m[94m--> [0mcrates/fly/src/localized_route.rs:7:18
  [1m[94m|[0m
[1m[94m7[0m [1m[94m|[0m use serde_json::{Map, Value};
  [1m[94m|[0m                  [1m[33m^^^[0m
  [1m[94m|[0m
...
[1m[91merror[E0609][0m[1m: no field `schema_version` on type `&mut model::ComponentObject`[0m
   [1m[94m--> [0mcrates/fly/src/binding.rs:364:42
    [1m[94m|[0m
[1m[94m364[0m [1m[94m|[0m             "schemaVersion" => component.schema_version = value.as_str().map(ToString::to_string),
    [1m[94m|[0m                                          [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `id`, `component_type`, `tag_name`, `provider`, `attributes` ... and 4 others

[1m[92m    Checking[0m v_escape-base v0.1.0
[1m[92m    Checking[0m v_htmlescape v0.17.0
[1m[91merror[E0609][0m[1m: no field `schema_version` on type `&model::ComponentObject`[0m
   [1m[94m--> [0mcrates/fly/src/trait_model.rs:129:46
    [1m[94m|[0m
[1m[94m129[0m [1m[94m|[0m                 "schemaVersion" => component.schema_version.clone().map(Value::String),
    [1m[94m|[0m                                              [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `id`, `component_type`, `tag_name`, `provider`, `attributes` ... and 4 others

[1m[91merror[E0609][0m[1m: no field `schema_version` on type `&model::ComponentObject`[0m
   [1m[94m--> [0mcrates/fly/src/validation.rs:253:54
    [1m[94m|[0m
[1m[94m253[0m [1m[94m|[0m         if component.provider.is_some() && component.schema_version.is_none() {
    [1m[94m|[0m                                                      [1m[91m^^^^^^^^^^^^^^[0m [1m[91munknown field[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: available fields are: `id`, `component_type`, `tag_name`, `provider`, `attributes` ... and 4 others
...
[1mFor more information about this error, try `rustc --explain E0609`.[0m
[1m[33mwarning[0m: `fly` (lib) generated 1 warning
[1m[91merror[0m: could not compile `fly` (lib) due to 3 previous errors; 1 warning emitted
