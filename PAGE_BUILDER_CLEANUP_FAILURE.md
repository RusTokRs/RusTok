...
[1m[91merror[E0308][0m[1m: mismatched types[0m
  [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:23:27
   [1m[94m|[0m
[1m[94m23[0m [1m[94m|[0m         target_providers: BTreeMap::new(),
   [1m[94m|[0m                           [1m[91m^^^^^^^^^^^^^^^[0m [1m[91mexpected `BTreeSet<String>`, found `BTreeMap<_, _>`[0m
   [1m[94m|[0m
   [1m[94m= [0m[1mnote[0m: expected struct `std::collections::[1m[35mBTreeSet<std::string::String>[0m`
              found struct `std::collections::[1m[35mBTreeMap<_, _>[0m`

[1m[91merror[E0061][0m[1m: this method takes 1 argument but 2 arguments were supplied[0m
  [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:35:10
   [1m[94m|[0m
[1m[94m35[0m [1m[94m|[0m         .insert("fly.builtin".to_string(), "1".to_string());
   [1m[94m|[0m          [1m[91m^^^^^^[0m                            [1m[94m---------------[0m [1m[94munexpected argument #2 of type `std::string::String`[0m
   [1m[94m|[0m
[1m[92mnote[0m: method defined here
  [1m[94m--> [0m/rustc/2d8144b7880597b6e6d3dfd63a9a9efae3f533d3/library/alloc/src/collections/btree/set.rs:900:11
[1m[96mhelp[0m: remove the extra argument
   [1m[94m|[0m
[1m[94m35[0m [91m- [0m        .insert("fly.builtin".to_string()[91m, "1".to_string()[0m);
[1m[94m35[0m [92m+ [0m        .insert("fly.builtin".to_string());
   [1m[94m|[0m

[1m[91merror[E0061][0m[1m: this method takes 1 argument but 2 arguments were supplied[0m
  [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:73:10
   [1m[94m|[0m
[1m[94m73[0m [1m[94m|[0m         .insert("fly.builtin".to_string(), "1".to_string());
   [1m[94m|[0m          [1m[91m^^^^^^[0m                            [1m[94m---------------[0m [1m[94munexpected argument #2 of type `std::string::String`[0m
   [1m[94m|[0m
[1m[92mnote[0m: method defined here
  [1m[94m--> [0m/rustc/2d8144b7880597b6e6d3dfd63a9a9efae3f533d3/library/alloc/src/collections/btree/set.rs:900:11
[1m[96mhelp[0m: remove the extra argument
   [1m[94m|[0m
[1m[94m73[0m [91m- [0m        .insert("fly.builtin".to_string()[91m, "1".to_string()[0m);
[1m[94m73[0m [92m+ [0m        .insert("fly.builtin".to_string());
   [1m[94m|[0m

[1m[91merror[E0308][0m[1m: mismatched types[0m
   [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:169:27
    [1m[94m|[0m
[1m[94m169[0m [1m[94m|[0m         target_providers: BTreeMap::from([("fly.builtin".to_string(), " 1 ".to_string())]),
    [1m[94m|[0m                           [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91mexpected `BTreeSet<String>`, found `BTreeMap<String, String>`[0m
    [1m[94m|[0m
    [1m[94m= [0m[1mnote[0m: expected struct `std::collections::[1m[35mBTreeSet<std::string::String>[0m`
               found struct `std::collections::[1m[35mBTreeMap<std::string::String, std::string::String>[0m`

[1m[91merror[E0061][0m[1m: this method takes 1 argument but 2 arguments were supplied[0m
   [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:175:22
    [1m[94m|[0m
[1m[94m175[0m [1m[94m|[0m     assert!(manifest.allows_target_provider("rustok.pages", "1"));
    [1m[94m|[0m                      [1m[91m^^^^^^^^^^^^^^^^^^^^^^[0m                 [1m[94m---[0m [1m[94munexpected argument #2 of type `&'static str`[0m
    [1m[94m|[0m
[1m[92mnote[0m: method defined here
   [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/model.rs:22:12
    [1m[94m|[0m
[1m[94m 22[0m [1m[94m|[0m     pub fn allows_target_provider(&self, provider: &str) -> bool {
    [1m[94m|[0m            [1m[92m^^^^^^^^^^^^^^^^^^^^^^[0m
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m175[0m [91m- [0m    assert!(manifest.allows_target_provider("rustok.pages"[91m, "1"[0m));
[1m[94m175[0m [92m+ [0m    assert!(manifest.allows_target_provider("rustok.pages"));
    [1m[94m|[0m

[1m[91merror[E0061][0m[1m: this method takes 1 argument but 2 arguments were supplied[0m
   [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:176:22
    [1m[94m|[0m
[1m[94m176[0m [1m[94m|[0m     assert!(manifest.allows_target_provider("fly.builtin", "1"));
    [1m[94m|[0m                      [1m[91m^^^^^^^^^^^^^^^^^^^^^^[0m                [1m[94m---[0m [1m[94munexpected argument #2 of type `&'static str`[0m
    [1m[94m|[0m
[1m[92mnote[0m: method defined here
   [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/model.rs:22:12
...
[1m[96mhelp[0m: remove the extra argument
    [1m[94m|[0m
[1m[94m176[0m [91m- [0m    assert!(manifest.allows_target_provider("fly.builtin"[91m, "1"[0m));
[1m[94m176[0m [92m+ [0m    assert!(manifest.allows_target_provider("fly.builtin"));
    [1m[94m|[0m

[1m[33mwarning[0m[1m: unused variable: `version`[0m
 [1m[94m--> [0mcrates/fly-ui/src/contribution_manifest/tests.rs:6:43
  [1m[94m|[0m
[1m[94m6[0m [1m[94m|[0m fn contribution(id: &str, provider: &str, version: &str) -> ContributionDescriptor {
  [1m[94m|[0m                                           [1m[33m^^^^^^^[0m [1m[33mhelp: if this is intentional, prefix it with an underscore: `_version`[0m
  [1m[94m|[0m
  [1m[94m= [0m[1mnote[0m: `#[warn(unused_variables)]` (part of `#[warn(unused)]`) on by default

[1mSome errors have detailed explanations: E0061, E0308.[0m
[1mFor more information about an error, try `rustc --explain E0061`.[0m
[1m[33mwarning[0m: `fly-ui` (lib test) generated 1 warning
[1m[91merror[0m: could not compile `fly-ui` (lib test) due to 6 previous errors; 1 warning emitted
