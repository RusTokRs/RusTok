...
[1m[92m    Finished[0m `dev` profile [unoptimized + debuginfo] target(s) in 1m 42s
...
[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 16.95s
...
test result: ok. 3 passed; 0 failed; 0 ignored; 0 measured; 174 filtered out; finished in 0.00s
...
test result: ok. 3 passed; 0 failed; 0 ignored; 0 measured; 174 filtered out; finished in 0.01s

[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 0.34s
[1m[92m     Running[0m unittests src/lib.rs (target/debug/deps/fly-494faf045f0adba3)
...
test result: ok. 2 passed; 0 failed; 0 ignored; 0 measured; 175 filtered out; finished in 0.00s

[1m[92m   Compiling[0m fly v0.1.0 (/home/runner/work/RusTok/RusTok/crates/fly)
[1m[92m   Compiling[0m fly-ui v0.1.0 (/home/runner/work/RusTok/RusTok/crates/fly-ui)
[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 8.61s
...
[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 1m 32s
[1m[33mwarning[0m: the following packages contain code that will be rejected by a future version of Rust: proc-macro-error2 v2.0.1
[1m[92mnote[0m: to see what the problems were, use the option `--future-incompat-report`, or run `cargo report future-incompatibilities --id 1`
...
test render::tests::localized_runtime_render_uses_project_translation_catalog ... FAILED
...
test runtime_context_dependency::tests::consumer_can_inspect_runtime_dependency_graph ... FAILED
...
test runtime_scenario_render::tests::consumer_can_render_runtime_scenario_matrix ... FAILED
...
test runtime_scenario_snapshot::tests::consumer_can_snapshot_and_diff_scenario_outputs ... FAILED
...
test service::tests::reference_service_renders_preview_and_validates_schema_contract ... FAILED
...
---- render::tests::localized_runtime_render_uses_project_translation_catalog stdout ----

thread 'render::tests::localized_runtime_render_uses_project_translation_catalog' (13453) panicked at crates/rustok-page-builder/src/render.rs:270:9:
assertion failed: html.contains("Добро пожаловать")
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

---- runtime_context_dependency::tests::consumer_can_inspect_runtime_dependency_graph stdout ----

thread 'runtime_context_dependency::tests::consumer_can_inspect_runtime_dependency_graph' (13463) panicked at crates/rustok-page-builder/src/runtime_context_dependency.rs:81:9:
assertion `left == right` failed
  left: Some(0)
 right: Some(1)

---- runtime_scenario_render::tests::consumer_can_render_runtime_scenario_matrix stdout ----

thread 'runtime_scenario_render::tests::consumer_can_render_runtime_scenario_matrix' (13466) panicked at crates/rustok-page-builder/src/runtime_scenario_render.rs:92:9:
assertion `left == right` failed
  left: 1
 right: 2

---- runtime_scenario_snapshot::tests::consumer_can_snapshot_and_diff_scenario_outputs stdout ----

thread 'runtime_scenario_snapshot::tests::consumer_can_snapshot_and_diff_scenario_outputs' (13467) panicked at crates/rustok-page-builder/src/runtime_scenario_snapshot.rs:163:9:
assertion `left == right` failed
  left: Stable
 right: RequiresReview

---- service::tests::reference_service_renders_preview_and_validates_schema_contract stdout ----

thread 'service::tests::reference_service_renders_preview_and_validates_schema_contract' (13481) panicked at crates/rustok-page-builder/src/service.rs:1228:14:
unsupported schema should fail validation: PreviewPageBuilderResult { page_id: "landing", html: "<div data-rustok-page-builder=\"grapesjs\"></div>" }


failures:
    render::tests::localized_runtime_render_uses_project_translation_catalog
    runtime_context_dependency::tests::consumer_can_inspect_runtime_dependency_graph
    runtime_scenario_render::tests::consumer_can_render_runtime_scenario_matrix
    runtime_scenario_snapshot::tests::consumer_can_snapshot_and_diff_scenario_outputs
    service::tests::reference_service_renders_preview_and_validates_schema_contract

test result: FAILED. 41 passed; 5 failed; 0 ignored; 0 measured; 0 filtered out; finished in 0.01s

[1m[91merror[0m: test failed, to rerun pass `-p rustok-page-builder --lib`
```
