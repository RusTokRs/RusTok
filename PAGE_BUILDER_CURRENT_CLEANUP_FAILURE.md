...
[1m[91merror[E0433][0m[1m: cannot find type `PageBuilderRuntimeCallStatus` in this scope[0m
    [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:1304:37
     [1m[94m|[0m
[1m[94m1304[0m [1m[94m|[0m         assert_eq!(evidence.status, PageBuilderRuntimeCallStatus::Started);
     [1m[94m|[0m                                     [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91muse of undeclared type `PageBuilderRuntimeCallStatus`[0m
     [1m[94m|[0m
[1m[96mhelp[0m: a struct with a similar name exists
     [1m[94m|[0m
[1m[94m1304[0m [91m- [0m        assert_eq!(evidence.status, [91mPageBuilderRuntimeCallStatus[0m::Started);
[1m[94m1304[0m [92m+ [0m        assert_eq!(evidence.status, [92mPageBuilderRuntimeCallEvidence[0m::Started);
     [1m[94m|[0m
[1m[96mhelp[0m: consider importing this enum
     [1m[94m|[0m
[1m[94m 791[0m [92m+ [0m    [92muse crate::runtime_telemetry::PageBuilderRuntimeCallStatus;[0m
     [1m[94m|[0m

[1m[91merror[E0433][0m[1m: cannot find type `PageBuilderRuntimeCallStatus` in this scope[0m
    [1m[94m--> [0mcrates/rustok-page-builder/src/service.rs:1313:35
     [1m[94m|[0m
[1m[94m1313[0m [1m[94m|[0m         assert_eq!(failed.status, PageBuilderRuntimeCallStatus::Failed);
     [1m[94m|[0m                                   [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m [1m[91muse of undeclared type `PageBuilderRuntimeCallStatus`[0m
     [1m[94m|[0m
[1m[96mhelp[0m: a struct with a similar name exists
     [1m[94m|[0m
[1m[94m1313[0m [91m- [0m        assert_eq!(failed.status, [91mPageBuilderRuntimeCallStatus[0m::Failed);
[1m[94m1313[0m [92m+ [0m        assert_eq!(failed.status, [92mPageBuilderRuntimeCallEvidence[0m::Failed);
     [1m[94m|[0m
[1m[96mhelp[0m: consider importing this enum
     [1m[94m|[0m
[1m[94m 791[0m [92m+ [0m    [92muse crate::runtime_telemetry::PageBuilderRuntimeCallStatus;[0m
...
[1mSome errors have detailed explanations: E0433, E0599.[0m
[1mFor more information about an error, try `rustc --explain E0433`.[0m
[1m[91merror[0m: could not compile `rustok-page-builder` (lib test) due to 3 previous errors
```
