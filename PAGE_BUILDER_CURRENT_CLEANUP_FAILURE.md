...
[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 17.23s
...
[1m[92m    Finished[0m `test` profile [unoptimized + debuginfo] target(s) in 9.32s
...
thread 'render::tests::localized_runtime_render_uses_project_translation_catalog' (13510) panicked at crates/rustok-page-builder/src/render.rs:270:9:
...
thread 'runtime_context_dependency::tests::consumer_can_inspect_runtime_dependency_graph' (13520) panicked at crates/rustok-page-builder/src/runtime_context_dependency.rs:81:9:
...
thread 'runtime_scenario_render::tests::consumer_can_render_runtime_scenario_matrix' (13523) panicked at crates/rustok-page-builder/src/runtime_scenario_render.rs:92:9:
assertion `left == right` failed
  left: 1
 right: 2
...
thread 'runtime_scenario_snapshot::tests::consumer_can_snapshot_and_diff_scenario_outputs' (13524) panicked at crates/rustok-page-builder/src/runtime_scenario_snapshot.rs:163:9:
assertion `left == right` failed
  left: Stable
...
thread 'service::tests::reference_service_renders_preview_and_validates_schema_contract' (13538) panicked at crates/rustok-page-builder/src/service.rs:1228:14:
