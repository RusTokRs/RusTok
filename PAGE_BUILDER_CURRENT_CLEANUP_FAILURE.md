...
[1m[91merror[E0560][0m[1m: struct `validation::ValidationDiagnostic` has no field named `component_id`[0m
   [1m[94m--> [0mcrates/fly/src/binding.rs:367:9
    [1m[94m|[0m
[1m[94m367[0m [1m[94m|[0m         component_id,
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^[0m [1m[91m`validation::ValidationDiagnostic` does not have this field[0m
    [1m[94m|[0m
...
[1m[91merror[0m: could not compile `fly` (lib) due to 1 previous error
