# Final Page Builder current-only cleanup failure
...
[1m[94m13[0m [1m[94m|[0m     NoopPageBuilderRuntimeTelemetry, PageBuilderRuntimeCallEvidence, PageBuilderRuntimeTelemetry,
   ...
   [1m[94m|[0m                                                                      [1m[94m|[0m
   [1m[94m|[0m                                                                      [1m[91m`PageBuilderRuntimeTelemetry` reimported here[0m
   [1m[94m|[0m                                                                      [1m[94mhelp: remove unnecessary import[0m
   [1m[94m|[0m
...
[1m[94m13[0m [1m[94m|[0m     NoopPageBuilderRuntimeTelemetry, PageBuilderRuntimeCallEvidence, PageBuilderRuntimeTelemetry,
   [1m[94m|[0m     [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m[1m[94m--[0m
   [1m[94m|[0m     [1m[94m|[0m
   [1m[94m|[0m     [1m[91m`NoopPageBuilderRuntimeTelemetry` reimported here[0m
   [1m[94m|[0m     [1m[94mhelp: remove unnecessary import[0m
   [1m[94m|[0m
...
[1m[94m13[0m [1m[94m|[0m     NoopPageBuilderRuntimeTelemetry, PageBuilderRuntimeCallEvidence, PageBuilderRuntimeTelemetry,
   [1m[94m|[0m                                      [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m[1m[94m--[0m
   [1m[94m|[0m                                      [1m[94m|[0m
   [1m[94m|[0m                                      [1m[91m`PageBuilderRuntimeCallEvidence` reimported here[0m
   [1m[94m|[0m                                      [1m[94mhelp: remove unnecessary import[0m
   [1m[94m|[0m
...
[1m[96mhelp[0m: consider importing this enum
     [1m[94m|[0m
[1m[94m 794[0m [92m+ [0m    [92muse crate::runtime_telemetry::PageBuilderRuntimeCallStatus;[0m
     [1m[94m|[0m
[1m[96mhelp[0m: if you import `PageBuilderRuntimeCallStatus`, refer to it directly
     [1m[94m|[0m
[1m[94m1295[0m [91m- [0m            [91mcrate::runtime_telemetry::crate::runtime_telemetry::[0mPageBuilderRuntimeCallStatus::Started
[1m[94m1295[0m [92m+ [0m            PageBuilderRuntimeCallStatus::Started
     [1m[94m|[0m
...
[1m[96mhelp[0m: if you import `PageBuilderRuntimeCallStatus`, refer to it directly
     [1m[94m|[0m
[1m[94m1307[0m [91m- [0m            [91mcrate::runtime_telemetry::crate::runtime_telemetry::[0mPageBuilderRuntimeCallStatus::Failed
[1m[94m1307[0m [92m+ [0m            PageBuilderRuntimeCallStatus::Failed
     [1m[94m|[0m

[1mFor more information about this error, try `rustc --explain E0252`.[0m
[1m[33mwarning[0m: `rustok-page-builder` (lib) generated 1 warning
[1m[91merror[0m: could not compile `rustok-page-builder` (lib) due to 3 previous errors; 1 warning emitted
[1m[33mwarning[0m: build failed, waiting for other jobs to finish...
[1mSome errors have detailed explanations: E0252, E0433.[0m
[1mFor more information about an error, try `rustc --explain E0252`.[0m
[1m[33mwarning[0m: `rustok-page-builder` (lib test) generated 1 warning (1 duplicate)
[1m[91merror[0m: could not compile `rustok-page-builder` (lib test) due to 5 previous errors; 1 warning emitted
```
