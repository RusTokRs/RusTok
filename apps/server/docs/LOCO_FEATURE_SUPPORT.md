...
| ORM/migrations/entities | `rustok-migrations` + SeaORM entities | SeaORM stack in the platform migration crate and server app | `docs/architecture/database.md`; `apps/server/docs/README.md` | Accepted | 2026-06-01 | `crates/rustok-migrations/src/lib.rs`; `apps/server/src/models/mod.rs` |
