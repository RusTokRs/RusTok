...
fn marketplace_seller_graphql_and_admin_transports_share_owner_ports() {
    let owner_graphql = include_str!("../../../crates/modules/rustok-marketplace-seller/src/graphql.rs");
    let owner_ports = include_str!("../../../crates/modules/rustok-marketplace-seller/src/ports.rs");
    let native_adapter = include_str!(
        "../../../crates/modules/rustok-marketplace-seller/admin/src/transport/native_server_adapter.rs"
    );
    let graphql_adapter = include_str!(
        "../../../crates/modules/rustok-marketplace-seller/admin/src/transport/graphql_adapter.rs"
    );
    let transport =
        include_str!("../../../crates/modules/rustok-marketplace-seller/admin/src/transport.rs");
    let admin_model = include_str!("../../../crates/modules/rustok-marketplace-seller/admin/src/model.rs");
