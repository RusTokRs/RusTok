...
fn marketplace_listing_external_events_use_a_sealed_typed_contract() {
    ...
    let owner_service =
        include_str!("../../../crates/modules/rustok-marketplace-listing/src/service.rs");
    let owner_receipts =
    ...
    let owner_lifecycle = include_str!(
        "../../../crates/modules/rustok-marketplace-listing/src/lifecycle_event_commands.rs"
    );
    let owner_replay = include_str!(
        "../../../crates/modules/rustok-marketplace-listing/src/replay_safe_commands.rs"
    );
    let owner_tests = include_str!(
        "../../../crates/modules/rustok-marketplace-listing/src/command_receipts_tests.rs"
    );
