//! High-level model helpers for `topic_field_definitions`.
//!
...
pub use super::_entities::topic_field_definitions::{ActiveModel, Column, Entity, Model, Relation};

// Maximum number of field definitions per entity type per tenant.
// Enforced in [`TopicFieldService::create`].
