...
- `rustok-commerce-admin` — commerce catalog CRUD плюс shipping-option compatibility management без переноса commerce-specific UI в host.
