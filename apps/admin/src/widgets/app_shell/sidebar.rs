...
fn NavIcon(d: &'static str) -> impl IntoView {
    let path = match d {
        ...
        "commerce" => {
            "M6 6h15l-1.5 9h-12L6 6zM6 6 5 3H3m6 18a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm9 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"
        }
        "dot" => "M12 12h.01",
        ...
        "users" => {
            "M17 20h5v-2a3 3 0 0 0-5.36-1.86M17 20H7m10 0v-2c0-.66-.13-1.28-.36-1.86M7 20H2v-2a3 3 0 0 1 5.36-1.86M15 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"
        }
        value => value,
    };
