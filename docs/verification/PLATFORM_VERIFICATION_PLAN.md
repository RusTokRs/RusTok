...
jobs. Formatting, all-feature owner/admin/server compile, focused tests,
verifiers, module validation, live negative transport requests, PostgreSQL role
mutation concurrency and multi-replica Redis recovery remain mandatory before
RBAC can be completed or blocked.
