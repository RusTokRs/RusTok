...
`core/rbac` remains in progress in draft PR #2870 with `P0=0, P1=10, P2=1,
...
also fails closed when a late sibling-scope definition would make one canonical
grant or operation receipt ambiguous in the legacy `(tenant, installation, key)`
shape. SQLite and source regressions cover upgrade, rollback, explicit scope,
