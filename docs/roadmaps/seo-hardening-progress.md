...
- [x] Persist bulk terminal state and terminal event transactionally. (#2020)
...
- [x] Add rollback coverage for bulk terminal state and terminal event transactions. (#2020)
...
- [x] Run `cargo fmt --check` for the affected workspace packages. (#2020)
- [x] Run `cargo check -p rustok-seo`. (#2020)
- [ ] Run `cargo test -p rustok-seo`. Full suite currently has nine pre-existing failures outside the bulk terminal slice.
- [x] Compile all SEO tests and run the bulk terminal integration, bulk service unit, and bulk event unit scopes. (#2020)
