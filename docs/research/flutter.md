...
- route contract — shell содержит `home/catalog/cart/profile`, монтирует module-owned catalog/cart package и сохраняет reserved `/modules/:routeSegment` для будущих generated storefront registry routes;
...
Следующий storefront шаг: довести cart-часть до canonical shared-transport reads/writes, когда соответствующая GraphQL/REST surface будет готова, затем перевести discovery package-ов на generated storefront registry wiring.
