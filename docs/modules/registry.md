...
| `search` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-search/docs/implementation-plan.md` (slice #24: lagging diagnostics table rows перенесены в core) |
