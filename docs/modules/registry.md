...
|---|---|---|---|---|---|
| `email` | none | `not_started` | `transport_verified` | `no_ui_boundary` | [Live plan](../../crates/rustok-email/docs/implementation-plan.md) |
...
| `channel` | admin | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-channel/docs/implementation-plan.md) |
...
| `outbox` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-outbox/docs/implementation-plan.md) |
| `index` | admin | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-index/docs/implementation-plan.md) |
...
| `comments` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-comments/docs/implementation-plan.md) |
...
| `commerce` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-commerce/docs/implementation-plan.md); commerce admin native order-change/cart-promotion adapter uses `HostRuntimeContext` DB plus typed `TransactionalEventBus`, without Loco dependencies. |
| `workflow` | admin | `phase_b_ready` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-workflow/docs/implementation-plan.md) |
| `region` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-region/docs/implementation-plan.md) |
...
| `customer` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-customer/docs/implementation-plan.md) |
...
| `inventory` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-inventory/docs/implementation-plan.md) |
...
| `payment` | storefront | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-payment/docs/implementation-plan.md) |
| `fulfillment` | admin + storefront | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-fulfillment/docs/implementation-plan.md) |
...
| `media` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-media/docs/implementation-plan.md) |
| `ai-media` | none | `not_started` | `boundary_ready` | `no_ui_boundary` | [Live plan](../../crates/rustok-ai-media/docs/implementation-plan.md) |
| `tax` | none | `not_started` | `in_progress` | `no_ui_boundary` | [Live plan](../../crates/rustok-tax/docs/implementation-plan.md) |
