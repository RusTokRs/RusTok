...
| `pricing` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-pricing/docs/implementation-plan.md` (slice: storefront core/transport/ui-leptos layers separated with native-first facade tests) |
