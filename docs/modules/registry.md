...
| `pricing` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-pricing/docs/implementation-plan.md` (slice: storefront presentation policy and route href builders moved into framework-agnostic core) |
