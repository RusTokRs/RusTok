...
| `region` | admin + storefront | `in_progress` | `not_started` | `core_transport_ui` | `crates/rustok-region/docs/implementation-plan.md` (slice #34: admin save-success selected/form/refresh/route-update outcome mapping moved into Leptos-free `RegionAdminSaveSuccessViewModel`; slice #33 moved open-detail success/error outcome mapping into core; fast guardrail `scripts/verify/verify-region-admin-boundary.mjs`; storefront keeps native/GraphQL transport split) |
