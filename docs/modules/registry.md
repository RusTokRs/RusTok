...
| `search` | admin + storefront | `in_progress` | `not_started` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #40: storefront core owns suggestions request policy and autocomplete min-length gate; native/GraphQL transport facade unchanged) |
