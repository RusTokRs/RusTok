...
| `product_relations` | none | `not_started` | `boundary_ready` | `no_ui_boundary` | [Live plan](../../crates/modules/rustok-product-relations/docs/implementation-plan.md); Product relations, merchandising associations (cross-sells, up-sells, related, accessories, alternatives) and reordering. SQLite verified 4/4. |
