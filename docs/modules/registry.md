...
| `blog` | admin + storefront | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-blog/docs/implementation-plan.md) |
...
| `rbac` | admin | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-rbac/docs/implementation-plan.md); `crates/rustok-rbac/contracts/rbac-fba-registry.json`, `crates/rustok-rbac/contracts/evidence/rbac-provider-runtime-order-smoke.json`, and `scripts/verify/verify-rbac-admin-boundary.mjs`. |
...
| `seo` | admin + storefront contracts | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-seo/docs/implementation-plan.md) |
| `media` | admin | `in_progress` | `boundary_ready` | `core_transport_ui` | [Live plan](../../crates/rustok-media/docs/implementation-plan.md); `crates/rustok-media/contracts/media-fba-registry.json`, `crates/rustok-media/contracts/evidence/media-provider-runtime-order-smoke.json`, and `scripts/verify/verify-media-admin-boundary.mjs`. |
