...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #29: dictionaries forms build core-owned mutation requests before calling module-owned transport; GraphQL fallback unchanged) |
