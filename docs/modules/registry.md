...
| `alloy` | none | `not_started` | `boundary_ready` | `no_ui_boundary` | [Live plan](../../crates/modules/alloy/docs/implementation-plan.md); `crates/modules/alloy/contracts/alloy-runtime-contract.json`, `crates/modules/alloy/contracts/evidence/alloy-runtime-static-matrix.json`, and `npm run verify:alloy:runtime-contract`. |
