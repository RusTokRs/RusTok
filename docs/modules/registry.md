...
| `ai-translation` | none | `not_started` | `in_progress` | `no_ui_boundary` | [Live plan](../../crates/rustok-ai-translation/docs/implementation-plan.md); bridge contracts, typed schemas, proposal-only validation, and dependency guard exist. Runtime registration remains gated on durable AI structured execution. |
