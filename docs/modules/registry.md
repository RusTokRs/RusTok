...
| `flex` | none | `not_started` | `in_progress` | `no_ui_boundary` | [Live plan](../../crates/flex/docs/implementation-plan.md) |
...
| `rbac` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-rbac/docs/implementation-plan.md); `scripts/verify/verify-rbac-admin-boundary.mjs` guards the owner-owned native admin boundary. |
...
| `comments` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-comments/docs/implementation-plan.md); `scripts/verify/verify-comments-admin-boundary.mjs`. |
...
| `workflow` | admin | `phase_b_ready` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-workflow/docs/implementation-plan.md) |
| `region` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-region/docs/implementation-plan.md); FFA slice #43 and `scripts/verify/verify-region-admin-boundary.mjs`; `scripts/verify/verify-region-storefront-boundary.mjs`. |
...
| `media` | admin | `in_progress` | `in_progress` | `core_transport_ui` | [Live plan](../../crates/rustok-media/docs/implementation-plan.md); `scripts/verify/verify-media-admin-boundary.mjs`. |
