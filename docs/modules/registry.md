...
| `region` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-region/docs/implementation-plan.md` (slice #8: storefront error status exposes host-readable DOM evidence attributes) |
