...
| `groups` | [plan](../../crates/rustok-groups/docs/implementation-plan.md) | `in_progress` | Execute the targeted module, FFA, multilingual, and FBA gates; then complete invitations, ownership transfer, receipts/events, and the first Forum provider integration. |
