...
| `ai` | [plan](../../crates/rustok-ai/docs/implementation-plan.md) | `in_progress` | R4 Rust, Next Admin, and i18n gates pass. Resolve platform module-manifest and cross-module FFA-plan gaps, then run the workspace gate; the generic host contribution remains separately platform-owned. |
