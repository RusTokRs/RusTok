...
| `ai` | [plan](../../crates/rustok-ai/docs/implementation-plan.md) | `in_progress` | Execute R1 approval recovery and persisted-history restart, then provider cassettes, security/migration parity, and deferred full verification. R0 stream/transport normalization is complete; the generic host contribution remains a separate platform-owned blocker. |
