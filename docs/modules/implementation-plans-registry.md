...
| `ai` | [plan](../../crates/rustok-ai/docs/implementation-plan.md) | `in_progress` | Rig registry-integrity, extension-scoped manifest validation, and generic host contribution evidence pass. Resolve remaining workspace-wide failures, then close final verification. |
