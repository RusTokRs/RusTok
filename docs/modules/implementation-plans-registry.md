...
| `rustok-ai` | `rustok-ai` | `crates/rustok-ai/docs/implementation-plan.md` | `in_progress` | `75%` | `agent` | `2026-06-19T05:30:00Z` | `AI ownership slice: media/alloy task slug definitions, validation helpers, and adapter APIs moved to rustok-ai-media and rustok-ai-alloy; registered dynamically via adapter APIs` | Parity and evidence hardening | `-` | `cargo test -p rustok-ai --lib` |
