...
| `ai` | [plan](../../crates/rustok-ai/docs/implementation-plan.md) | `in_progress` | Rig and host-contribution evidence pass. Agent-principal and owner-workflow contracts are active; add persistence, scheduler, model assignments, and public catalog surfaces before final verification. |
