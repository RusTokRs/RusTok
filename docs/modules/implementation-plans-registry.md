...
| `rustok-ai-product` | `rustok-ai-product` | `crates/rustok-ai-product/docs/implementation-plan.md` | `in_progress` | `60%` | `agent` | `2026-06-19T06:15:00Z` | `product support crate owns product_copy/product_attributes descriptors, generated payload contracts, validation, and handler adapter API consumed by rustok-ai` | Добавить targeted verification при разрешённых компиляциях | compile/test evidence отложен по явному ограничению итерации: без компиляций | `cargo test -p rustok-ai-product --lib` |
| `rustok-ai-order` | `rustok-ai-order` | `crates/rustok-ai-order/docs/implementation-plan.md` | `in_progress` | `55%` | `agent` | `2026-06-19T06:15:00Z` | `order support crate owns order_analytics/order_ops_assistant descriptors, generated payload contracts, stricter validation, and handler adapter API consumed by rustok-ai` | Добавить targeted verification при разрешённых компиляциях | compile/test evidence отложен по явному ограничению итерации: без компиляций | `cargo test -p rustok-ai-order --lib` |
