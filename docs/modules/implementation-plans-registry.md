...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Name approved relation-event consumers with durable monotonic apply/ack against bounded owner replay, compose deployment retention maintenance, and collect PostgreSQL plus storefront/privacy/Media/CLI/runtime evidence. |
