...
| `events` | [plan](../../crates/rustok-events/docs/implementation-plan.md) | `in_progress` | Compose the delivered Social Graph to Index consumer into default-off host lifecycle, retry/DLQ, readiness/shutdown, and multi-replica replay recovery evidence. |
...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Compose the delivered Social Graph to Index consumer lifecycle and retry/DLQ, then prove replay repair and retain storefront/privacy/Media/CLI/PostgreSQL evidence. |
