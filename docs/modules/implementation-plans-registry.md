...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Collect compiled/runtime evidence for storefront transports, privacy and Media paths, GraphQL/CLI operation telemetry, and backfill failure stages; then extend observability to Social Graph commands. |
