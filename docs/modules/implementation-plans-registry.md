...
| `rustok-ui-i18n` | `rustok-ui-i18n` | `crates/rustok-ui-i18n/docs/implementation-plan.md` | `in_progress` | `35%` | `agent` | `2026-07-07T00:00:00Z` | `framework-agnostic UI message catalog crate extracted from rustok-api helpers with rustok-api transition re-exports` | Migrate module UI package imports from `rustok_api` to `rustok_ui_i18n` in small batches and add verifier coverage | `-` | `cargo test -p rustok-ui-i18n --lib`; `cargo test -p rustok-api --lib` |
