...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Collect compiled/runtime evidence for storefront transports, privacy and Media paths, and owner-operation telemetry; then extend observability to CLI backfill and Social Graph commands. |
