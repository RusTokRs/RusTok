...
| `media` | [plan](../../crates/rustok-media/docs/implementation-plan.md) | `in_progress` | Storage/media delivery plan is complete, including Local/S3 lifecycle and shared embedded/loopback gRPC conformance. Continue FFA parity separately; require isolated deployment evidence before `transport_verified`. |
...
| `translation` | [plan](../../crates/rustok-translation/docs/implementation-plan.md) | `in_progress` | Verify durable inventory cursor replay and recovery, then implement the manual job/proposal/review/apply vertical before adding AI. |
