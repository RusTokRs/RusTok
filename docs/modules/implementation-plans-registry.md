...
| `events` | [plan](../../crates/rustok-events/docs/implementation-plan.md) | `in_progress` | Prove real-Iggy cursor/position recovery, DLQ/ack failure, multi-replica behavior, PostgreSQL concurrency, bounded replay repair, and durable DLQ identity. |
...
| `iggy` | [plan](../../crates/rustok-iggy/docs/implementation-plan.md) | `in_progress` | Prove real SDK consume/commit and every-partition position snapshot/reconnect/TLS/multi-replica behavior, then execute DLQ/replay resilience. |
...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Prove replay repair, PostgreSQL concurrency, real-Iggy consumer/lag recovery, retained storefront/privacy/Media/CLI evidence, and durable DLQ identity. |
