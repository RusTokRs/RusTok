...
| `channel` | [plan](../../crates/rustok-channel/docs/implementation-plan.md) | `in_progress` | Execute the wired SQLite, two-runtime and PostgreSQL generation evidence, then add Redis loss and resolved-value convergence coverage. |
