...
| `next_plan_id` | `rustok-index` | ID записи, которую должен взять следующий агент |
| `last_rotation_at` | `2026-06-20T14:30:00Z` | Когда указатель был сдвинут последний раз |
