...
| `events` | [plan](../../crates/rustok-events/docs/implementation-plan.md) | `in_progress` | Add dedicated Social Graph Index consumer metrics, then prove real-Iggy restart, DLQ/ack failure, multi-replica recovery, PostgreSQL concurrency, and bounded replay repair. |
...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Add dedicated Social Graph Index consumer metrics, then prove replay repair, PostgreSQL concurrency, real-Iggy recovery, and retained storefront/privacy/Media/CLI evidence. |
