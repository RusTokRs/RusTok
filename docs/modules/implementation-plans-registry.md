...
| `events` | [plan](../../crates/rustok-events/docs/implementation-plan.md) | `in_progress` | Add connector high-watermark lag, then prove real-Iggy restart, DLQ/ack failure, multi-replica recovery, PostgreSQL concurrency, and bounded replay repair. |
...
| `iggy` | [plan](../../crates/rustok-iggy/docs/implementation-plan.md) | `in_progress` | Complete real SDK consume/commit, then execute DLQ/replay and resilience evidence against bundled and external Iggy. |
...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Add true connector high-watermark lag, then prove replay repair, PostgreSQL concurrency, real-Iggy recovery, and retained storefront/privacy/Media/CLI evidence. |
...
| `telemetry` | [plan](../../crates/rustok-telemetry/docs/implementation-plan.md) | `in_progress` | Prove runtime collector registration/shutdown, add high-watermark lag conventions, and harden shared metric safety. |
