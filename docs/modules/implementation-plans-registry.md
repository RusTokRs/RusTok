...
| `events` | [plan](../../crates/rustok-events/docs/implementation-plan.md) | `in_progress` | Compose the approved Social Graph to Index persistent consumer, result-first acknowledgement, DLQ, and replay-driven recovery after the event-runtime lifecycle gate. |
...
| `profiles` | [plan](../../crates/rustok-profiles/docs/implementation-plan.md) | `in_progress` | Compose the approved Social Graph to Index durable apply/ack and replay repair, then deployment retention maintenance and retained storefront/privacy/Media/CLI/runtime evidence. |
