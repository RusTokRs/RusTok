...
- [ADR: Typed module command-context evidence](../DECISIONS/2026-08-22-module-command-context-evidence.md) — one UUID-backed command identity preserved by lifecycle receipts and outbox events.
