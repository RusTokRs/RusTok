...
- [Архитектура GraphQL и Leptos server functions](./UI/graphql-architecture.md) — текущий dual-path contract для Leptos UI: native `#[server]` first, GraphQL parallel.
...
- [РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…](../DECISIONS/README.md) РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… (ADR).
  - [ADR: Leptos `#[server]` functions как внутренний data-layer с сохранённым GraphQL parallel path](../DECISIONS/2026-03-29-leptos-server-functions-as-internal-data-layer.md)
...
- [РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… API](./architecture/api.md)
  ...
  - РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р… auth lifecycle consistency, Rich-text/Page Builder input contract РїС—Р… Medusa-style ecommerce transport Рё typed shipping-profile registry
...
- [README admin UI `rustok-media`](../crates/rustok-media/admin/README.md) — module-owned Leptos admin surface `/modules/media`, native `#[server]` first, GraphQL fallback для read/delete/translation/usage и REST upload path
- [README admin UI `rustok-comments`](../crates/rustok-comments/admin/README.md) — module-owned Leptos admin moderation surface `/modules/comments`, native `#[server]` path без legacy fallback, потому что отдельного GraphQL/REST transport у comments не было
...
- [README crate `rustok-media`](../crates/rustok-media/README.md) — media GraphQL/REST transports плюс module-owned admin UI `rustok-media-admin`
- [README crate `rustok-comments`](../crates/rustok-comments/README.md) — generic comments domain, operator moderation API и module-owned admin UI `rustok-comments-admin`
...
- [README crate `rustok-ai`](../crates/rustok-ai/README.md)
- [РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… crate `rustok-ai`](../crates/rustok-ai/docs/README.md)
...
- [РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р… Content](../crates/rustok-content/docs/README.md) РїС—Р… shared helper/orchestration РїС—Р…РїС—Р…РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р… no longer exposes product GraphQL/REST/admin/storefront surfaces
...
- `rustok-ai`: [README](../crates/rustok-ai/README.md), [docs/README](../crates/rustok-ai/docs/README.md), [docs/implementation-plan](../crates/rustok-ai/docs/implementation-plan.md) РїС—Р… AI host/orchestrator capability РїС—Р…РїС—Р…РїС—Р… `rustok-mcp`, provider abstraction, persisted control plane РїС—Р… capability-owned Leptos/Next admin UI packages
