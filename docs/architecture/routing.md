...
- owner-owned REST handlers/DTOs live in `crates/modules/rustok-<module>/src/rest` or
  `crates/modules/rustok-<module>/src/controllers`;
- owner-owned GraphQL roots/DTOs live in `crates/modules/rustok-<module>/src/graphql`;
