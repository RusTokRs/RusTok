---
id: doc://docs/operations/script-script-command-github-workflows-ci-yml-github-actions-job-build-server.md
kind: operations_documentation
language: en
source_language: en
entities:
  - script-command://.github/workflows/ci.yml#github-actions:job:build-server
...
- Canonical entity: `script-command://.github/workflows/ci.yml#github-actions:job:build-server`
...
Generated from diagnostic `diag_script_62aea18b0db1008b`. Review this page before relying on it as operational documentation.
