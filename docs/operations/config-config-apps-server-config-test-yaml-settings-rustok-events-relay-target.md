---
id: doc://docs/operations/config-config-apps-server-config-test-yaml-settings-rustok-events-relay-target.md
...
- Canonical entity: `config://apps/server/config/test.yaml#settings.rustok.events.relay_target`
- Entity kind: `feature`
- Source: `apps/server/config/test.yaml`:61
...
- `apps/server/config/test.yaml:61`

## Notes

Generated from diagnostic `diag_env_fb0f34d7378b9441`. Review this page before relying on it as operational documentation.
