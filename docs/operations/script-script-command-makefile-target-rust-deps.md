---
id: doc://docs/operations/script-script-command-makefile-target-rust-deps.md
kind: operations_documentation
language: en
source_language: en
entities:
  - script-command://Makefile#target:rust-deps
last_verified_snapshot: snap_jsonl_00000021
status: verified
---

# Script Command `make rust-deps`
...
- Canonical entity: `script-command://Makefile#target:rust-deps`
...
Generated from diagnostic `diag_script_bddc6a94d9f20550`. Review this page before relying on it as operational documentation.
